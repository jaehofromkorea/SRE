 ...
 */var pf;function Wp(){if(pf)return bn;pf=1;var b=Symbol.for("react.transitional.element"),U=Symbol.for("react.fragment");function B(m,L,Y){var Z=null;if(Y!==void 0&&(Z=""+Y),L.key!==void 0&&(Z=""+L.key),"key"in L){Y={};for(var P in L)P!=="key"&&(Y[P]=L[P])}else Y=L;return L=Y.ref,{$$typeof:b,type:m,key:Z,ref:L!==void 0?L:null,props:Y}}return bn.Fragment=U,bn.jsx=B,bn.jsxs=B,bn}var hf;function Jp(){return hf||(hf=1,sc.exports=Wp()),sc.exports}var u=Jp(),ic={exports:{}},K={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var gf;function Pp(){if(gf)return K;gf=1;var b=Symbol.for("react.transitional.element"),U=Symbol.for("react.portal"),B=Symbol.for("react.fragment"),m=Symbol.for("react.strict_mode"),L=Symbol.for("react.profiler"),Y=Symbol.for("react.consumer"),Z=Symbol.for("react.context"),P=Symbol.for("react.forward_ref"),k=Symbol.for("react.suspense"),S=Symbol.for("react.memo"),q=Symbol.for("react.lazy"),D=Symbol.for("react.activity"),H=Symbol.iterator;function se(r){return r===null||typeof r!="object"?null:(r=H&&r[H]||r["@@iterator"],typeof r=="function"?r:null)}var me={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},xe=Object.assign,Be={};function Ye(r,p,x){this.props=r,this.context=p,this.refs=Be,this.updater=x||me}Ye.prototype.isReactComponent={},Ye.prototype.setState=function(r,p){if(typeof r!="object"&&typeof r!="function"&&r!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,r,p,"setState")},Ye.prototype.forceUpdate=function(r){this.updater.enqueueForceUpdate(this,r,"forceUpdate")};function Ct(){}Ct.prototype=Ye.prototype;function Me(r,p,x){this.props=r,this.context=p,this.refs=Be,this.updater=x||me}var Ve=Me.prototype=new Ct;Ve.constructor=Me,xe(Ve,Ye.prototype),Ve.isPureReactComponent=!0;var dt=Array.isArray;function He(){}var $={H:null,A:null,T:null,S:null},Ge=Object.prototype.hasOwnProperty;function Fe(r,p,x){var M=x.ref;return{$$typeof:b,type:r,key:p,ref:M!==void 0?M:null,props:x}}function Jt(r,p){return Fe(r.type,p,r.props)}function ft(r){return typeof r=="object"&&r!==null&&r.$$typeof===b}function Ce(r){var p={"=":"=0",":":"=2"};return"$"+r.replace(/[=:]/g,function(x){return p[x]})}var qt=/\/+/g;function _t(r,p){return typeof r=="object"&&r!==null&&r.key!=null?Ce(""+r.key):p.toString(36)}function et(r){switch(r.status){case"fulfilled":return r.value;case"rejected":throw r.reason;default:switch(typeof r.status=="string"?r.then(He,He):(r.status="pending",r.then(function(p){r.status==="pending"&&(r.status="fulfilled",r.value=p)},function(p){r.status==="pending"&&(r.status="rejected",r.reason=p)})),r.status){case"fulfilled":return r.value;case"rejected":throw r.reason}}throw r}function T(r,p,x,M,z){var V=typeof r;(V==="undefined"||V==="boolean")&&(r=null);var F=!1;if(r===null)F=!0;else switch(V){case"bigint":case"string":case"number":F=!0;break;case"object":switch(r.$$typeof){case b:case U:F=!0;break;case q:return F=r._init,T(F(r._payload),p,x,M,z)}}if(F)return z=z(r),F=M===""?"."+_t(r,0):M,dt(z)?(x="",F!=null&&(x=F.replace(qt,"$&/")+"/"),T(z,p,x,"",function(xl){return xl})):z!=null&&(ft(z)&&(z=Jt(z,x+(z.key==null||r&&r.key===z.key?"":(""+z.key).replace(qt,"$&/")+"/")+F)),p.push(z)),1;F=0;var Oe=M===""?".":M+":";if(dt(r))for(var ge=0;ge<r.length;ge++)M=r[ge],V=Oe+_t(M,ge),F+=T(M,p,x,V,z);else if(ge=se(r),typeof ge=="function")for(r=ge.call(r),ge=0;!(M=r.next()).done;)M=M.value,V=Oe+_t(M,ge++),F+=T(M,p,x,V,z);else if(V==="object"){if(typeof r.then=="function")return T(et(r),p,x,M,z);throw p=String(r),Error("Objects are not valid as a React child (found: "+(p==="[object Object]"?"object with keys {"+Object.keys(r).join(", ")+"}":p)+"). If you meant to render a collection of children, use an array instead.")}return F}function O(r,p,x){if(r==null)return r;var M=[],z=0;return T(r,M,"","",function(V){return p.call(x,V,z++)}),M}function Q(r){if(r._status===-1){var p=r._result;p=p(),p.then(function(x){(r._status===0||r._status===-1)&&(r._status=1,r._result=x)},function(x){(r._status===0||r._status===-1)&&(r._status=2,r._result=x)}),r._status===-1&&(r._status=0,r._result=p)}if(r._status===1)return r._result.default;throw r._result}var A=typeof reportError=="function"?reportError:function(r){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var p=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof r=="object"&&r!==null&&typeof r.message=="string"?String(r.message):String(r),error:r});if(!window.dispatchEvent(p))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",r);return}console.error(r)},C={map:O,forEach:function(r,p,x){O(r,function(){p.apply(this,arguments)},x)},count:function(r){var p=0;return O(r,function(){p++}),p},toArray:function(r){return O(r,function(p){return p})||[]},only:function(r){if(!ft(r))throw Error("React.Children.only expected to receive a single React element child.");return r}};return K.Activity=D,K.Children=C,K.Component=Ye,K.Fragment=B,K.Profiler=L,K.PureComponent=Me,K.StrictMode=m,K.Suspense=k,K.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=$,K.__COMPILER_RUNTIME={__proto__:null,c:function(r){return $.H.useMemoCache(r)}},K.cache=function(r){return function(){return r.apply(null,arguments)}},K.cacheSignal=function(){return null},K.cloneElement=function(r,p,x){if(r==null)throw Error("The argument must be a React element, but you passed "+r+".");var M=xe({},r.props),z=r.key;if(p!=null)for(V in p.key!==void 0&&(z=""+p.key),p)!Ge.call(p,V)||V==="key"||V==="__self"||V==="__source"||V==="ref"&&p.ref===void 0||(M[V]=p[V]);var V=arguments.length-2;if(V===1)M.children=x;else if(1<V){for(var F=Array(V),Oe=0;Oe<V;Oe++)F[Oe]=arguments[Oe+2];M.children=F}return Fe(r.type,z,M)},K.createContext=function(r){return r={$$typeof:Z,_currentValue:r,_currentValue2:r,_threadCount:0,Provider:null,Consumer:null},r.Provider=r,r.Consumer={$$typeof:Y,_context:r},r},K.createElement=function(r,p,x){var M,z={},V=null;if(p!=null)for(M in p.key!==void 0&&(V=""+p.key),p)Ge.call(p,M)&&M!=="key"&&M!=="__self"&&M!=="__source"&&(z[M]=p[M]);var F=arguments.length-2;if(F===1)z.children=x;else if(1<F){for(var Oe=Array(F),ge=0;ge<F;ge++)Oe[ge]=arguments[ge+2];z.children=Oe}if(r&&r.defaultProps)for(M in F=r.defaultProps,F)z[M]===void 0&&(z[M]=F[M]);return Fe(r,V,z)},K.createRef=function(){return{current:null}},K.forwardRef=function(r){return{$$typeof:P,render:r}},K.isValidElement=ft,K.lazy=function(r){return{$$typeof:q,_payload:{_status:-1,_result:r},_init:Q}},K.memo=function(r,p){return{$$typeof:S,type:r,compare:p===void 0?null:p}},K.startTransition=function(r){var p=$.T,x={};$.T=x;try{var M=r(),z=$.S;z!==null&&z(x,M),typeof M=="object"&&M!==null&&typeof M.then=="function"&&M.then(He,A)}catch(V){A(V)}finally{p!==null&&x.types!==null&&(p.types=x.types),$.T=p}},K.unstable_useCacheRefresh=function(){return $.H.useCacheRefresh()},K.use=function(r){return $.H.use(r)},K.useActionState=function(r,p,x){return $.H.useActionState(r,p,x)},K.useCallback=function(r,p){return $.H.useCallback(r,p)},K.useContext=function(r){return $.H.useContext(r)},K.useDebugValue=function(){},K.useDeferredValue=function(r,p){return $.H.useDeferredValue(r,p)},K.useEffect=function(r,p){return $.H.useEffect(r,p)},K.useEffectEvent=function(r){return $.H.useEffectEvent(r)},K.useId=function(){return $.H.useId()},K.useImperativeHandle=function(r,p,x){return $.H.useImperativeHandle(r,p,x)},K.useInsertionEffect=function(r,p){return $.H.useInsertionEffect(r,p)},K.useLayoutEffect=function(r,p){return $.H.useLayoutEffect(r,p)},K.useMemo=function(r,p){return $.H.useMemo(r,p)},K.useOptimistic=function(r,p){return $.H.useOptimistic(r,p)},K.useReducer=function(r,p,x){return $.H.useReducer(r,p,x)},K.useRef=function(r){return $.H.useRef(r)},K.useState=function(r){return $.H.useState(r)},K.useSyncExternalStore=function(r,p,x){return $.H.useSyncExternalStore(r,p,x)},K.useTransition=function(){return $.H.useTransition()},K.version="19.2.0",K}var yf;function dc(){return yf||(yf=1,ic.exports=Pp()),ic.exports}var ke=dc(),oc={exports:{}},En={},cc={exports:{}},uc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var vf;function Fp(){return vf||(vf=1,(function(b){function U(T,O){var Q=T.length;T.push(O);e:for(;0<Q;){var A=Q-1>>>1,C=T[A];if(0<L(C,O))T[A]=O,T[Q]=C,Q=A;else break e}}function B(T){return T.length===0?null:T[0]}function m(T){if(T.length===0)return null;var O=T[0],Q=T.pop();if(Q!==O){T[0]=Q;e:for(var A=0,C=T.length,r=C>>>1;A<r;){var p=2*(A+1)-1,x=T[p],M=p+1,z=T[M];if(0>L(x,Q))M<C&&0>L(z,x)?(T[A]=z,T[M]=Q,A=M):(T[A]=x,T[p]=Q,A=p);else if(M<C&&0>L(z,Q))T[A]=z,T[M]=Q,A=M;else break e}}return O}function L(T,O){var Q=T.sortIndex-O.sortIndex;return Q!==0?Q:T.id-O.id}if(b.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var Y=performance;b.unstable_now=function(){return Y.now()}}else{var Z=Date,P=Z.now();b.unstable_now=function(){return Z.now()-P}}var k=[],S=[],q=1,D=null,H=3,se=!1,me=!1,xe=!1,Be=!1,Ye=typeof setTimeout=="function"?setTimeout:null,Ct=typeof clearTimeout=="function"?clearTimeout:null,Me=typeof setImmediate<"u"?setImmediate:null;function Ve(T){for(var O=B(S);O!==null;){if(O.callback===null)m(S);else if(O.startTime<=T)m(S),O.sortIndex=O.expirationTime,U(k,O);else break;O=B(S)}}function dt(T){if(xe=!1,Ve(T),!me)if(B(k)!==null)me=!0,He||(He=!0,Ce());else{var O=B(S);O!==null&&et(dt,O.startTime-T)}}var He=!1,$=-1,Ge=5,Fe=-1;function Jt(){return Be?!0:!(b.unstable_now()-Fe<Ge)}function ft(){if(Be=!1,He){var T=b.unstable_now();Fe=T;var O=!0;try{e:{me=!1,xe&&(xe=!1,Ct($),$=-1),se=!0;var Q=H;try{t:{for(Ve(T),D=B(k);D!==null&&!(D.expirationTime>T&&Jt());){var A=D.callback;if(typeof A=="function"){D.callback=null,H=D.priorityLevel;var C=A(D.expirationTime<=T);if(T=b.unstable_now(),typeof C=="function"){D.callback=C,Ve(T),O=!0;break t}D===B(k)&&m(k),Ve(T)}else m(k);D=B(k)}if(D!==null)O=!0;else{var r=B(S);r!==null&&et(dt,r.startTime-T),O=!1}}break e}finally{D=null,H=Q,se=!1}O=void 0}}finally{O?Ce():He=!1}}}var Ce;if(typeof Me=="function")Ce=function(){Me(ft)};else if(typeof MessageChannel<"u"){var qt=new MessageChannel,_t=qt.port2;qt.port1.onmessage=ft,Ce=function(){_t.postMessage(null)}}else Ce=function(){Ye(ft,0)};function et(T,O){$=Ye(function(){T(b.unstable_now())},O)}b.unstable_IdlePriority=5,b.unstable_ImmediatePriority=1,b.unstable_LowPriority=4,b.unstable_NormalPriority=3,b.unstable_Profiling=null,b.unstable_UserBlockingPriority=2,b.unstable_cancelCallback=function(T){T.callback=null},b.unstable_forceFrameRate=function(T){0>T||125<T?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Ge=0<T?Math.floor(1e3/T):5},b.unstable_getCurrentPriorityLevel=function(){return H},b.unstable_next=function(T){switch(H){case 1:case 2:case 3:var O=3;break;default:O=H}var Q=H;H=O;try{return T()}finally{H=Q}},b.unstable_requestPaint=function(){Be=!0},b.unstable_runWithPriority=function(T,O){switch(T){case 1:case 2:case 3:case 4:case 5:break;default:T=3}var Q=H;H=T;try{return O()}finally{H=Q}},b.unstable_scheduleCallback=function(T,O,Q){var A=b.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?A+Q:A):Q=A,T){case 1:var C=-1;break;case 2:C=250;break;case 5:C=1073741823;break;case 4:C=1e4;break;default:C=5e3}return C=Q+C,T={id:q++,callback:O,priorityLevel:T,startTime:Q,expirationTime:C,sortIndex:-1},Q>A?(T.sortIndex=Q,U(S,T),B(k)===null&&T===B(S)&&(xe?(Ct($),$=-1):xe=!0,et(dt,Q-A))):(T.sortIndex=C,U(k,T),me||se||(me=!0,He||(He=!0,Ce()))),T},b.unstable_shouldYield=Jt,b.unstable_wrapCallback=function(T){var O=H;return function(){var Q=H;H=O;try{return T.apply(this,arguments)}finally{H=Q}}}})(uc)),uc}var Sf;function e0(){return Sf||(Sf=1,cc.exports=Fp()),cc.exports}var rc={exports:{}},Qe={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var bf;function t0(){if(bf)return Qe;bf=1;var b=dc();function U(k){var S="https://react.dev/errors/"+k;if(1<arguments.length){S+="?args[]="+encodeURIComponent(arguments[1]);for(var q=2;q<arguments.length;q++)S+="&args[]="+encodeURIComponent(arguments[q])}return"Minified React error #"+k+"; visit "+S+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function B(){}var m={d:{f:B,r:function(){throw Error(U(522))},D:B,C:B,L:B,m:B,X:B,S:B,M:B},p:0,findDOMNode:null},L=Symbol.for("react.portal");function Y(k,S,q){var D=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:L,key:D==null?null:""+D,children:k,containerInfo:S,implementation:q}}var Z=b.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function P(k,S){if(k==="font")return"";if(typeof S=="string")return S==="use-credentials"?S:""}return Qe.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=m,Qe.createPortal=function(k,S){var q=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!S||S.nodeType!==1&&S.nodeType!==9&&S.nodeType!==11)throw Error(U(299));return Y(k,S,null,q)},Qe.flushSync=function(k){var S=Z.T,q=m.p;try{if(Z.T=null,m.p=2,k)return k()}finally{Z.T=S,m.p=q,m.d.f()}},Qe.preconnect=function(k,S){typeof k=="string"&&(S?(S=S.crossOrigin,S=typeof S=="string"?S==="use-credentials"?S:"":void 0):S=null,m.d.C(k,S))},Qe.prefetchDNS=function(k){typeof k=="string"&&m.d.D(k)},Qe.preinit=function(k,S){if(typeof k=="string"&&S&&typeof S.as=="string"){var q=S.as,D=P(q,S.crossOrigin),H=typeof S.integrity=="string"?S.integrity:void 0,se=typeof S.fetchPriority=="string"?S.fetchPriority:void 0;q==="style"?m.d.S(k,typeof S.precedence=="string"?S.precedence:void 0,{crossOrigin:D,integrity:H,fetchPriority:se}):q==="script"&&m.d.X(k,{crossOrigin:D,integrity:H,fetchPriority:se,nonce:typeof S.nonce=="string"?S.nonce:void 0})}},Qe.preinitModule=function(k,S){if(typeof k=="string")if(typeof S=="object"&&S!==null){if(S.as==null||S.as==="script"){var q=P(S.as,S.crossOrigin);m.d.M(k,{crossOrigin:q,integrity:typeof S.integrity=="string"?S.integrity:void 0,nonce:typeof S.nonce=="string"?S.nonce:void 0})}}else S==null&&m.d.M(k)},Qe.preload=function(k,S){if(typeof k=="string"&&typeof S=="object"&&S!==null&&typeof S.as=="string"){var q=S.as,D=P(q,S.crossOrigin);m.d.L(k,q,{crossOrigin:D,integrity:typeof S.integrity=="string"?S.integrity:void 0,nonce:typeof S.nonce=="string"?S.nonce:void 0,type:typeof S.type=="string"?S.type:void 0,fetchPriority:typeof S.fetchPriority=="string"?S.fetchPriority:void 0,referrerPolicy:typeof S.referrerPolicy=="string"?S.referrerPolicy:void 0,imageSrcSet:typeof S.imageSrcSet=="string"?S.imageSrcSet:void 0,imageSizes:typeof S.imageSizes=="string"?S.imageSizes:void 0,media:typeof S.media=="string"?S.media:void 0})}},Qe.preloadModule=function(k,S){if(typeof k=="string")if(S){var q=P(S.as,S.crossOrigin);m.d.m(k,{as:typeof S.as=="string"&&S.as!=="script"?S.as:void 0,crossOrigin:q,integrity:typeof S.integrity=="string"?S.integrity:void 0})}else m.d.m(k)},Qe.requestFormReset=function(k){m.d.r(k)},Qe.unstable_batchedUpdates=function(k,S){return k(S)},Qe.useFormState=function(k,S,q){return Z.H.useFormState(k,S,q)},Qe.useFormStatus=function(){return Z.H.useHostTransitionStatus()},Qe.version="19.2.0",Qe}var Ef;function a0(){if(Ef)return rc.exports;Ef=1;function b(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(b)}catch(U){console.error(U)}}return b(),rc.exports=t0(),rc.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Tf;function l0(){if(Tf)return En;Tf=1;var b=e0(),U=dc(),B=a0();function m(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)t+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function L(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function Y(e){var t=e,a=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(a=t.return),e=t.return;while(e)}return t.tag===3?a:null}function Z(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function P(e){if(e.tag===31){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function k(e){if(Y(e)!==e)throw Error(m(188))}function S(e){var t=e.alternate;if(!t){if(t=Y(e),t===null)throw Error(m(188));return t!==e?null:e}for(var a=e,l=t;;){var n=a.return;if(n===null)break;var s=n.alternate;if(s===null){if(l=n.return,l!==null){a=l;continue}break}if(n.child===s.child){for(s=n.child;s;){if(s===a)return k(n),e;if(s===l)return k(n),t;s=s.sibling}throw Error(m(188))}if(a.return!==l.return)a=n,l=s;else{for(var i=!1,o=n.child;o;){if(o===a){i=!0,a=n,l=s;break}if(o===l){i=!0,l=n,a=s;break}o=o.sibling}if(!i){for(o=s.child;o;){if(o===a){i=!0,a=s,l=n;break}if(o===l){i=!0,l=s,a=n;break}o=o.sibling}if(!i)throw Error(m(189))}}if(a.alternate!==l)throw Error(m(190))}if(a.tag!==3)throw Error(m(188));return a.stateNode.current===a?e:t}function q(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=q(e),t!==null)return t;e=e.sibling}return null}var D=Object.assign,H=Symbol.for("react.element"),se=Symbol.for("react.transitional.element"),me=Symbol.for("react.portal"),xe=Symbol.for("react.fragment"),Be=Symbol.for("react.strict_mode"),Ye=Symbol.for("react.profiler"),Ct=Symbol.for("react.consumer"),Me=Symbol.for("react.context"),Ve=Symbol.for("react.forward_ref"),dt=Symbol.for("react.suspense"),He=Symbol.for("react.suspense_list"),$=Symbol.for("react.memo"),Ge=Symbol.for("react.lazy"),Fe=Symbol.for("react.activity"),Jt=Symbol.for("react.memo_cache_sentinel"),ft=Symbol.iterator;function Ce(e){return e===null||typeof e!="object"?null:(e=ft&&e[ft]||e["@@iterator"],typeof e=="function"?e:null)}var qt=Symbol.for("react.client.reference");function _t(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===qt?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case xe:return"Fragment";case Ye:return"Profiler";case Be:return"StrictMode";case dt:return"Suspense";case He:return"SuspenseList";case Fe:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case me:return"Portal";case Me:return e.displayName||"Context";case Ct:return(e._context.displayName||"Context")+".Consumer";case Ve:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case $:return t=e.displayName||null,t!==null?t:_t(e.type)||"Memo";case Ge:t=e._payload,e=e._init;try{return _t(e(t))}catch{}}return null}var et=Array.isArray,T=U.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,O=B.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,Q={pending:!1,data:null,method:null,action:null},A=[],C=-1;function r(e){return{current:e}}function p(e){0>C||(e.current=A[C],A[C]=null,C--)}function x(e,t){C++,A[C]=e.current,e.current=t}var M=r(null),z=r(null),V=r(null),F=r(null);function Oe(e,t){switch(x(V,t),x(z,e),x(M,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?Ud(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=Ud(t),e=zd(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}p(M),x(M,e)}function ge(){p(M),p(z),p(V)}function xl(e){e.memoizedState!==null&&x(F,e);var t=M.current,a=zd(t,e.type);t!==a&&(x(z,e),x(M,a))}function Tn(e){z.current===e&&(p(M),p(z)),F.current===e&&(p(F),gn._currentValue=Q)}var Hs,fc;function _a(e){if(Hs===void 0)try{throw Error()}catch(a){var t=a.stack.trim().match(/\n( *(at )?)/);Hs=t&&t[1]||"",fc=-1<a.stack.indexOf(`
...
\`\`\``,checklist:["modules/app-stack/ 디렉토리에 재사용 가능한 모듈 작성","3개 리전(서울/오리건/싱가포르)에 각각 스택 배포","Route53에서 Geolocation 라우팅 설정 (아시아→서울, 미국→오리건)","db-replication.sh로 서울→오리건 DB 실시간 복제 설정","VPN으로 미국 IP 사용해서 오리건 서버로 라우팅되는지 확인"]}]}}}]}]},o0=({size:b=24})=>u.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:b,height:b,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[u.jsx("path",{d:"m9 11-6 6v3h9l3-3"}),u.jsx("path",{d:"m22 12-4.6 4.6a2 2 0 0 1-2.8 0l-5.2-5.2a2 2 0 0 1 0-2.8L14 4"})]}),c0=({size:b=24})=>u.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:b,height:b,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[u.jsx("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),u.jsx("line",{x1:"6",y1:"6",x2:"18",y2:"18"})]});function u0({isActive:b,onToggle:U}){return u.jsx("button",{onClick:U,className:`
        fixed bottom-6 right-6 w-14 h-14 rounded-full shadow-lg z-50
        flex items-center justify-center
        transition-all duration-200
        ${b?"bg-red-600 hover:bg-red-700 rotate-90":"bg-indigo-600 hover:bg-indigo-700"}
        text-white
        hover:scale-110
        active:scale-95
      `,"aria-label":b?"하이라이터 모드 끄기":"하이라이터 모드 켜기",title:b?"하이라이터 모드 끄기 (클릭)":"하이라이터 모드 켜기 (클릭)",children:b?u.jsx(c0,{size:24}):u.jsx(o0,{size:24})})}function r0(){const b=window.getSelection();return b?b.toString().trim():""}function d0(){const b=window.getSelection();return!b||b.rangeCount===0?null:b.getRangeAt(0).getBoundingClientRect()}function f0(b){if(!b)return null;const U=window.innerHeight,B=window.innerWidth,m=window.scrollY,L=window.scrollX,Y=b.top+m,Z=b.bottom+m,P=b.left+L;b.right+L;const k=P+b.width/2,S=b.bottom>U/2,q=60,D=10;let H,se;S?(H=Y-q-D,se="top"):(H=Z+D,se="bottom");let me=k;const Be=300/2;return me-Be<L+10?me=L+Be+10:me+Be>L+B-10&&(me=L+B-Be-10),{x:me,y:H,placement:se}}function m0({isActive:b,onTextSelected:U}){const B=ke.useRef(null);return ke.useEffect(()=>{if(!b)return;const m=()=>{B.current&&clearTimeout(B.current),B.current=setTimeout(()=>{const P=r0();if(console.log("[TextSelection] Selected text:",P),!P||P.length<2){console.log("[TextSelection] Text too short or empty");return}const k=d0();if(console.log("[TextSelection] Selection rect:",k),!k){console.log("[TextSelection] No bounding rect");return}const S=f0(k);if(console.log("[TextSelection] Menu position:",S),!S){console.log("[TextSelection] Failed to calculate position");return}U({text:P,position:S})},150)},L=P=>{P.preventDefault()},Y=()=>{console.log("[TextSelection] Mouse/Touch up detected"),m()},Z=()=>{const P=window.getSelection();P&&P.toString().trim().length>0&&(console.log("[TextSelection] Selection changed:",P.toString()),m())};return document.addEventListener("mouseup",Y),document.addEventListener("touchend",Y),document.addEventListener("selectionchange",Z),document.addEventListener("contextmenu",L),()=>{B.current&&clearTimeout(B.current),document.removeEventListener("mouseup",Y),document.removeEventListener("touchend",Y),document.removeEventListener("selectionchange",Z),document.removeEventListener("contextmenu",L)}},[b,U]),null}const p0=()=>u.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[u.jsx("circle",{cx:"12",cy:"12",r:"10"}),u.jsx("line",{x1:"12",y1:"8",x2:"12",y2:"12"}),u.jsx("line",{x1:"12",y1:"16",x2:"12.01",y2:"16"})]}),h0=()=>u.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[u.jsx("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),u.jsx("polyline",{points:"14 2 14 8 20 8"}),u.jsx("line",{x1:"16",y1:"13",x2:"8",y2:"13"}),u.jsx("line",{x1:"16",y1:"17",x2:"8",y2:"17"}),u.jsx("polyline",{points:"10 9 9 9 8 9"})]}),g0=()=>u.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[u.jsx("circle",{cx:"11",cy:"11",r:"8"}),u.jsx("path",{d:"m21 21-4.35-4.35"})]}),y0=()=>u.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[u.jsx("rect",{x:"9",y:"9",width:"13",height:"13",rx:"2",ry:"2"}),u.jsx("path",{d:"M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"})]});function v0({selectedText:b,position:U,onImportant:B,onMemo:m,onSearch:L,onCopy:Y,onClose:Z}){if(!b||!U)return null;const{x:P,y:k,placement:S}=U;return u.jsxs(u.Fragment,{children:[u.jsx("div",{className:"fixed inset-0 z-40",onClick:Z}),u.jsxs("div",{className:"fixed z-50 bg-white rounded-lg shadow-xl border border-gray-200 animate-fade-in",style:{left:`${P}px`,top:`${k}px`,transform:"translateX(-50%)"},children:[S==="top"&&u.jsx("div",{className:`absolute left-1/2 -bottom-2 w-0 h-0 border-l-8 border-r-8 border-t-8
                          border-l-transparent border-r-transparent border-t-white
                          transform -translate-x-1/2`}),S==="bottom"&&u.jsx("div",{className:`absolute left-1/2 -top-2 w-0 h-0 border-l-8 border-r-8 border-b-8
                          border-l-transparent border-r-transparent border-b-white
                          transform -translate-x-1/2`}),u.jsxs("div",{className:"flex items-center gap-1 p-2",children:[u.jsxs("button",{onClick:()=>{B(b),Z()},className:`flex items-center gap-2 px-3 py-2 rounded-md hover:bg-red-50
                       text-red-600 font-medium transition-colors`,title:"중요! 표시",children:[u.jsx(p0,{}),u.jsx("span",{className:"text-sm whitespace-nowrap",children:"중요!"})]}),u.jsx("div",{className:"w-px h-6 bg-gray-200"}),u.jsxs("button",{onClick:()=>{m(b),Z()},className:`flex items-center gap-2 px-3 py-2 rounded-md hover:bg-indigo-50
                       text-indigo-600 font-medium transition-colors`,title:"메모 작성",children:[u.jsx(h0,{}),u.jsx("span",{className:"text-sm whitespace-nowrap",children:"메모"})]}),u.jsx("div",{className:"w-px h-6 bg-gray-200"}),u.jsxs("button",{onClick:()=>{L(b),Z()},className:`flex items-center gap-2 px-3 py-2 rounded-md hover:bg-blue-50
                       text-blue-600 font-medium transition-colors`,title:"Google 검색",children:[u.jsx(g0,{}),u.jsx("span",{className:"text-sm whitespace-nowrap",children:"검색"})]}),u.jsx("div",{className:"w-px h-6 bg-gray-200"}),u.jsxs("button",{onClick:()=>{Y(b),Z()},className:`flex items-center gap-2 px-3 py-2 rounded-md hover:bg-green-50
                       text-green-600 font-medium transition-colors`,title:"클립보드에 복사",children:[u.jsx(y0,{}),u.jsx("span",{className:"text-sm whitespace-nowrap",children:"복사"})]})]})]})]})}function S0({message:b,type:U="success",onClose:B}){ke.useEffect(()=>{const L=setTimeout(()=>{B()},3e3);return()=>clearTimeout(L)},[B]);const m=U==="success"?"bg-green-600":"bg-red-600";return u.jsx("div",{className:"fixed bottom-24 left-1/2 transform -translate-x-1/2 z-50 animate-fade-in",children:u.jsxs("div",{className:`${m} text-white px-6 py-3 rounded-lg shadow-lg
                      flex items-center gap-2 min-w-64 max-w-md`,children:[U==="success"?u.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[u.jsx("path",{d:"M22 11.08V12a10 10 0 1 1-5.93-9.14"}),u.jsx("polyline",{points:"22 4 12 14.01 9 11.01"})]}):u.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[u.jsx("circle",{cx:"12",cy:"12",r:"10"}),u.jsx("line",{x1:"15",y1:"9",x2:"9",y2:"15"}),u.jsx("line",{x1:"9",y1:"9",x2:"15",y2:"15"})]}),u.jsx("span",{className:"font-medium",children:b})]})})}const b0=({label:b,isSelected:U,onClick:B})=>u.jsx("button",{type:"button",onClick:B,className:`
      px-4 py-2 rounded-lg font-medium transition-all duration-200
      ${U?"bg-indigo-600 text-white shadow-md scale-105":"bg-gray-100 text-gray-700 hover:bg-gray-200"}
    `,children:b});function E0({selectedText:b,onSave:U,onClose:B}){const[m,L]=ke.useState(""),[Y,Z]=ke.useState(""),P=["@이해","@질문","@심화","@상세"],k=()=>{if(!m){alert("카테고리를 선택해주세요.");return}if(!Y.trim()){alert("메모 내용을 입력해주세요.");return}U({text:b,category:m,memo:Y.trim()}),B()},S=q=>{(q.ctrlKey||q.metaKey)&&q.key==="Enter"&&k()};return u.jsx(u.Fragment,{children:u.jsx("div",{className:"fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4",onClick:B,children:u.jsxs("div",{className:"bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-fade-in",onClick:q=>q.stopPropagation(),children:[u.jsxs("div",{className:"sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between",children:[u.jsx("h2",{className:"text-xl font-bold text-gray-800",children:"메모 작성"}),u.jsx("button",{onClick:B,className:"text-gray-400 hover:text-gray-600 transition-colors","aria-label":"닫기",children:u.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[u.jsx("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),u.jsx("line",{x1:"6",y1:"6",x2:"18",y2:"18"})]})})]}),u.jsxs("div",{className:"p-6 space-y-6",children:[u.jsxs("div",{children:[u.jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:"선택된 텍스트"}),u.jsx("div",{className:"bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded",children:u.jsx("p",{className:"text-gray-800 leading-relaxed",children:b})})]}),u.jsxs("div",{children:[u.jsxs("label",{className:"block text-sm font-medium text-gray-700 mb-3",children:["카테고리 선택 ",u.jsx("span",{className:"text-red-500",children:"*"})]}),u.jsx("div",{className:"flex flex-wrap gap-3",children:P.map(q=>u.jsx(b0,{label:q,isSelected:m===q,onClick:()=>L(q)},q))})]}),u.jsxs("div",{children:[u.jsxs("label",{className:"block text-sm font-medium text-gray-700 mb-2",children:["메모 내용 ",u.jsx("span",{className:"text-red-500",children:"*"})]}),u.jsx("textarea",{value:Y,onChange:q=>Z(q.target.value),onKeyDown:S,placeholder:"메모를 입력하세요... (Ctrl/Cmd + Enter로 저장)",className:`w-full h-40 px-4 py-3 border border-gray-300 rounded-lg
                       ...
                       hover:bg-gray-50 transition-colors`,children:"취소"}),u.jsx("button",{onClick:k,className:`px-5 py-2.5 rounded-lg font-medium text-white bg-indigo-600
                       hover:bg-indigo-700 transition-colors shadow-md hover:shadow-lg`,children:"저장"})]})]})})})}function T0(){const[b,U]=ke.useState(()=>{try{const S=localStorage.getItem("cms-tracker-notes");return S?JSON.parse(S):{highlights:[],memos:[]}}catch(S){return console.error("Failed to load notes:",S),{highlights:[],memos:[]}}});return ke.useEffect(()=>{try{localStorage.setItem("cms-tracker-notes",JSON.stringify(b))}catch(S){console.error("Failed to save notes:",S)}},[b]),{notes:b,addHighlight:(S,q="")=>{const D={id:crypto.randomUUID(),text:S,type:"important",timestamp:new Date().toISOString(),source:q};return U(H=>({...H,highlights:[...H.highlights,D]})),D.id},addMemo:(S,q,D,H="")=>{const se={id:crypto.randomUUID(),text:S,category:q,memo:D,timestamp:new Date().toISOString(),source:H};return U(me=>({...me,memos:[...me.memos,se]})),se.id},deleteNote:(S,q)=>{q==="highlight"?U(D=>({...D,highlights:D.highlights.filter(H=>H.id!==S)})):q==="memo"&&U(D=>({...D,memos:D.memos.filter(H=>H.id!==S)}))},updateNote:(S,q,D)=>{q==="highlight"?U(H=>({...H,highlights:H.highlights.map(se=>se.id===S?{...se,...D}:se)})):q==="memo"&&U(H=>({...H,memos:H.memos.map(se=>se.id===S?{...se,...D}:se)}))},clearAllNotes:()=>{confirm("모든 노트를 삭제하시겠습니까?")&&U({highlights:[],memos:[]})},exportNotes:()=>{const S=JSON.stringify(b,null,2),q=new Blob([S],{type:"application/json"}),D=URL.createObjectURL(q),H=document.createElement("a");H.href=D,H.download=`cms-notes-${new Date().toISOString().split("T")[0]}.json`,H.click(),URL.revokeObjectURL(D)},importNotes:S=>{try{const q=JSON.parse(S);return q.highlights&&q.memos?(U(q),!0):!1}catch(q){return console.error("Failed to import notes:",q),!1}}}}const Af=({size:b=24})=>u.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:b,height:b,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:u.jsx("polyline",{points:"6 9 12 15 18 9"})}),xf=({size:b=24})=>u.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:b,height:b,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:u.jsx("polyline",{points:"9 18 15 12 9 6"})}),_0=({size:b=20,className:U=""})=>u.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:b,height:b,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",className:U,children:[u.jsx("path",{d:"M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"}),u.jsx("path",{d:"m9 12 2 2 4-4"})]}),R0=({size:b=20,className:U=""})=>u.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:b,height:b,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",className:U,children:u.jsx("circle",{cx:"12",cy:"12",r:"10"})}),A0=({size:b=16})=>u.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:b,height:b,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[u.jsx("circle",{cx:"12",cy:"12",r:"10"}),u.jsx("polyline",{points:"12 6 12 12 16 14"})]}),x0=({size:b=16})=>u.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:b,height:b,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[u.jsx("circle",{cx:"12",cy:"12",r:"10"}),u.jsx("circle",{cx:"12",cy:"12",r:"6"}),u.jsx("circle",{cx:"12",cy:"12",r:"2"})]}),C0=({size:b=20,className:U=""})=>u.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:b,height:b,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",className:U,children:[u.jsx("path",{d:"M4 19.5A2.5 2.5 0 0 1 6.5 17H20"}),u.jsx("path",{d:"M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"})]}),O0=({size:b=16,className:U=""})=>u.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:b,height:b,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",className:U,children:[u.jsx("circle",{cx:"12",cy:"12",r:"10"}),u.jsx("line",{x1:"12",y1:"8",x2:"12",y2:"12"}),u.jsx("line",{x1:"12",y1:"16",x2:"12.01",y2:"16"})]});function D0(){const[b,U]=ke.useState({}),[B,m]=ke.useState({}),[L,Y]=ke.useState({}),[Z,P]=ke.useState({}),[k,S]=ke.useState(!1),[q,D]=ke.useState(null),[H,se]=ke.useState(null),[me,xe]=ke.useState(!1),[Be,Ye]=ke.useState(""),{addHighlight:Ct,addMemo:Me}=T0();ke.useEffect(()=>{const A=localStorage.getItem("cms-tracker-progress");if(A)try{const C=JSON.parse(A);Y(C.completedTasks||{}),P(C.activeLevel||{}),U(C.expandedTiers||{}),m(C.expandedTopics||{})}catch(C){console.error("Failed to load progress:",C)}},[]),ke.useEffect(()=>{const A={completedTasks:L,activeLevel:Z,expandedTiers:b,expandedTopics:B,lastUpdated:new Date().toISOString()};localStorage.setItem("cms-tracker-progress",JSON.stringify(A))},[L,Z,b,B]);const Ve=A=>{U(C=>({...C,[A]:!C[A]}))},dt=A=>{m(C=>({...C,[A]:!C[A]}))},He=A=>{Y(C=>({...C,[A]:!C[A]}))},$=(A,C)=>{P(r=>({...r,[A]:r[A]===C?null:C}))},Ge=A=>{let C=0,r=0;return A.topics.forEach(p=>{p.tasks&&p.tasks.forEach((x,M)=>{C++;const z=`${p.id}-task-${M}`;L[z]&&r++})}),C>0?Math.round(r/C*100):0},Fe=()=>{let A=0,C=0;return Rf.tiers.forEach(r=>{r.topics.forEach(p=>{p.tasks&&p.tasks.forEach((x,M)=>{A++;const z=`${p.id}-task-${M}`;L[z]&&C++})})}),A>0?Math.round(C/A*100):0},Jt=A=>A.topics.reduce((C,r)=>C+(r.hours||0),0),ft=A=>{D(A)},Ce=(A,C="success")=>{se({message:A,type:C})},qt=A=>{const C=Ct(A);Ce("중요! 표시로 저장되었습니다"),console.log("하이라이트 추가됨:",C)},_t=A=>{Ye(A),xe(!0)},et=A=>{const C=Me(A.text,A.category,A.memo);Ce("메모가 저장되었습니다"),console.log("메모 추가됨:",C)},T=A=>{const C=encodeURIComponent(A);window.open(`https://www.google.com/search?q=${C}`,"_blank")},O=async A=>{try{await navigator.clipboard.writeText(A),Ce("클립보드에 복사되었습니다")}catch(C){console.error("복사 실패:",C),Ce("복사에 실패했습니다","error")}},Q=A=>!A||!A.sections?null:u.jsx("div",{className:"content-section",children:A.sections.map((C,r)=>u.jsxs("div",{className:"mb-4",children:[C.heading&&u.jsx("h3",{className:"font-bold text-lg mb-2",children:C.heading}),C.content&&u.jsx("p",{className:"mb-2",children:C.content}),C.list&&u.jsx("ul",{className:"list-disc pl-6 mb-2",children:C.list.map((p,x)=>u.jsx("li",{children:p},x))}),C.code&&u.jsx("pre",{className:"bg-slate-800 text-slate-100 p-4 rounded-lg overflow-x-auto mb-2",children:u.jsx("code",{children:C.code})}),C.steps&&u.jsx("div",{className:"space-y-2",children:C.steps.map((p,x)=>u.jsxs("div",{children:[u.jsxs("p",{className:"font-semibold",children:[p.label,": ",p.text]}),p.code&&u.jsx("pre",{className:"bg-slate-800 text-slate-100 p-3 rounded-lg overflow-x-auto mt-1",children:u.jsx("code",{children:p.code})}),p.note&&u.jsx("p",{className:"text-sm text-slate-600 mt-1",children:p.note})]},x))}),C.checklist&&u.jsxs(u.Fragment,{children:[u.jsx("ul",{className:"list-none pl-0",children:C.checklist.map((p,x)=>u.jsxs("li",{className:"flex items-start gap-2",children:[u.jsx("span",{children:"□"}),u.jsx("span",{children:p})]},x))}),C.nextStep&&u.jsxs("p",{className:"mt-3 font-semibold",children:["다음 단계: ",C.nextStep]})]})]},r))});return u.jsxs("div",{className:"min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4 sm:p-6",children:[u.jsxs("div",{className:"max-w-6xl mx-auto",children:[u.jsxs("div",{className:"bg-white rounded-xl shadow-lg p-6 sm:p-8 mb-6",children:[u.jsx("h1",{className:"text-2xl sm:text-3xl font-bold text-slate-800 mb-2",children:"CMS 운영 학습 프레임워크"}),u.jsx("p",{className:"text-slate-600 mb-6 text-sm sm:text-base",children:"CapRover + Docker 환경에서 멀티 컨테이너 CMS 운영을 위한 체계적 학습 로드맵"}),u.jsxs("div",{className:"bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg p-4 border border-indigo-200",children:[u.jsxs("div",{className:"flex items-center justify-between mb-2",children:[u.jsx("span",{className:"text-sm font-semibold text-slate-700",children:"전체 진도율"}),u.jsxs("span",{className:"text-2xl font-bold text-indigo-600",children:[Fe(),"%"]})]}),u.jsx("div",{className:"w-full bg-slate-200 rounded-full h-3",children:u.jsx("div",{className:"bg-gradient-to-r from-indigo-500 to-purple-500 h-3 rounded-full transition-all duration-500",style:{width:`${Fe()}%`}})})]})]}),Rf.tiers.map(A=>{const C=Ge(A),r=b[A.id];return u.jsx("div",{className:"mb-4",children:u.jsxs("div",{className:`rounded-xl shadow-md border-2 overflow-hidden ${A.color}`,children:[u.jsx("button",{onClick:()=>Ve(A.id),className:"w-full p-4 sm:p-5 text-left hover:opacity-80 transition-opacity",children:u.jsxs("div",{className:"flex items-start justify-between",children:[u.jsxs("div",{className:"flex-1",children:[u.jsxs("div",{className:"flex items-center gap-2 sm:gap-3 mb-2",children:[r?u.jsx(Af,{size:20}):u.jsx(xf,{size:20}),u.jsx("h2",{className:"text-lg sm:text-xl font-bold",children:A.name}),u.jsxs("span",{className:"text-xs sm:text-sm opacity-75",children:["(",A.period,")"]})]}),u.jsxs("p",{className:"text-xs sm:text-sm ml-7 sm:ml-9 opacity-90",children:["📌 ",A.reason]}),u.jsxs("div",{className:"flex items-center gap-3 sm:gap-4 ml-7 sm:ml-9 mt-2 text-xs sm:text-sm",children:[u.jsxs("div",{className:"flex items-center gap-1",children:[u.jsx(A0,{size:14}),u.jsxs("span",{children:[Jt(A),"시간"]})]}),u.jsxs("div",{className:"flex items-center gap-1",children:[u.jsx(x0,{size:14}),u.jsxs("span",{children:[A.topics.length,"개 주제"]})]})]})]}),u.jsxs("div",{className:"text-right ml-4",children:[u.jsxs("div",{className:"text-xl sm:text-2xl font-bold mb-1",children:[C,"%"]}),u.jsx("div",{className:"w-16 sm:w-24 bg-white bg-opacity-50 rounded-full h-2",children:u.jsx("div",{className:"bg-current h-2 rounded-full transition-all duration-500",style:{width:`${C}%`}})})]})]})}),r&&u.jsx("div",{className:"bg-white p-4 sm:p-5 space-y-3",children:A.topics.map(p=>{const x=B[p.id],M=p.tasks?p.tasks.filter((V,F)=>L[`${p.id}-task-${F}`]).length:0,z=Z[p.id];return u.jsxs("div",{className:"border border-slate-200 rounded-lg overflow-hidden",children:[u.jsx("button",{onClick:()=>dt(p.id),className:"w-full p-3 sm:p-4 text-left hover:bg-slate-50 transition-colors",children:u.jsx("div",{className:"flex items-start justify-between",children:u.jsxs("div",{className:"flex-1",children:[u.jsxs("div",{className:"flex items-center gap-2 mb-1",children:[x?u.jsx(Af,{size:16}):u.jsx(xf,{size:16}),u.jsxs("h3",{className:"font-semibold text-slate-800 text-sm sm:text-base",children:[p.id,". ",p.name]})]}),u.jsx("p",{className:"text-xs sm:text-sm text-slate-600 ml-5 sm:ml-6",children:p.goal}),u.jsxs("div",{className:"flex items-center gap-2 ml-5 sm:ml-6 mt-2 flex-wrap",children:[u.jsxs("span",{className:"text-xs bg-slate-100 text-slate-600 px-2 py-1 rounded",children:["⏱️ ",p.hours,"시간"]}),p.tasks&&p.tasks.length>0&&u.jsxs("span",{className:"text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded",children:["✓ ",M,"/",p.tasks.length," 완료"]})]})]})})}),x&&u.jsxs("div",{className:"border-t border-slate-200",children:[p.content&&u.jsx("div",{className:"bg-slate-50 border-b border-slate-200",children:u.jsxs("div",{className:"flex gap-2 p-3 sm:p-4 overflow-x-auto",children:[u.jsx("button",{onClick:()=>$(p.id,"beginner"),className:`px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors whitespace-nowrap ${z==="beginner"?"bg-green-100 text-green-800 border-2 border-green-300":"bg-white text-slate-600 border border-slate-300 hover:bg-slate-100"}`,children:"🌱 초급"}),u.jsx("button",{onClick:()=>$(p.id,"intermediate"),className:`px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors whitespace-nowrap ${z==="intermediate"?"bg-blue-100 text-blue-800 border-2 border-blue-300":"bg-white text-slate-600 border border-slate-300 hover:bg-slate-100"}`,children:"🚀 중급"}),u.jsx("button",{onClick:()=>$(p.id,"advanced"),className:`px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors whitespace-nowrap ${z==="advanced"?"bg-purple-100 text-purple-800 border-2 border-purple-300":"bg-white text-slate-600 border border-slate-300 hover:bg-slate-100"}`,children:"⚡ 고급"})]})}),z&&p.content&&p.content[z]&&u.jsxs("div",{className:"p-4 sm:p-6 bg-gradient-to-br from-white to-slate-50",children:[u.jsxs("div",{className:"flex items-center gap-2 mb-4",children:[u.jsx(C0,{className:"text-indigo-600",size:20}),u.jsx("h4",{className:"font-bold text-base sm:text-lg text-slate-800",children:p.content[z].title})]}),u.jsx("div",{className:"bg-white rounded-lg p-4 sm:p-5 shadow-sm border border-slate-200",children:Q(p.content[z])})]}),!z&&u.jsxs("div",{className:"p-3 sm:p-4 bg-slate-50",children:[p.keywords&&u.jsxs("div",{className:"mb-4",children:[u.jsx("p",{className:"text-xs font-semibold text-slate-600 mb-2",children:"🏷️ 키워드"}),u.jsx("div",{className:"flex flex-wrap gap-2",children:p.keywords.map((V,F)=>u.jsx("span",{className:"text-xs bg-white text-slate-700 px-2 py-1 rounded border border-slate-200",children:V},F))})]}),p.tasks&&p.tasks.length>0&&u.jsxs("div",{children:[u.jsx("p",{className:"text-xs font-semibold text-slate-600 mb-2",children:"✅ 실습 과제"}),u.jsx("div",{className:"space-y-2",children:p.tasks.map((V,F)=>{const Oe=`${p.id}-task-${F}`,ge=L[Oe];return u.jsxs("button",{onClick:()=>He(Oe),className:"w-full flex items-start gap-3 p-3 bg-white rounded-lg hover:shadow-md transition-shadow text-left",children:[ge?u.jsx(_0,{size:18,className:"text-green-500 flex-shrink-0 mt-0.5"}):u.jsx(R0,{size:18,className:"text-slate-300 flex-shrink-0 mt-0.5"}),u.jsx("span",{className:`text-xs sm:text-sm ${ge?"text-slate-400 line-through":"text-slate-700"}`,children:V})]},Oe)})})]})]})]})]},p.id)})})]})},A.id)}),u.jsxs("div",{className:"bg-white rounded-xl shadow-lg p-4 sm:p-6 mt-6 text-center text-xs sm:text-sm text-slate-600",children:[u.jsxs("p",{className:"flex items-center justify-center gap-2 flex-wrap",children:[u.jsx(O0,{size:16,className:"text-indigo-600"}),u.jsxs("span",{children:["각 주제를 클릭하고 ",u.jsx("strong",{children:"초급/중급/고급"})," 버튼으로 단계별 학습 내용을 확인하세요"]})]}),u.jsx("p",{className:"mt-2",children:"실습 과제를 클릭하여 완료 표시를 하면 진도가 자동으로 계산됩니다"}),u.jsx("p",{className:"mt-4 text-xs text-slate-500",children:"💡 진도는 자동으로 저장됩니다"})]})]}),u.jsx(u0,{isActive:k,onToggle:()=>S(!k)}),u.jsx(m0,{isActive:k,onTextSelected:ft}),u.jsx(v0,{selectedText:q?.text,position:q?.position,onImportant:qt,onMemo:_t,onSearch:T,onCopy:O,onClose:()=>D(null)}),me&&u.jsx(E0,{selectedText:Be,onSave:et,onClose:()=>xe(!1)}),H&&u.jsx(S0,{message:H.message,type:H.type,onClose:()=>se(null)})]})}s0.createRoot(document.getElementById("root")).render(u.jsx(ke.StrictMode,{children:u.jsx(D0,{})}));
