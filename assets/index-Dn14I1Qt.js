 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var em;function l0(){return em||(em=1,(function(o){function u(A,z){var H=A.length;A.push(z);e:for(;0<H;){var N=H-1>>>1,U=A[N];if(0<v(U,z))A[N]=z,A[H]=U,H=N;else break e}}function m(A){return A.length===0?null:A[0]}function r(A){if(A.length===0)return null;var z=A[0],H=A.pop();if(H!==z){A[0]=H;e:for(var N=0,U=A.length,p=U>>>1;N<p;){var S=2*(N+1)-1,B=A[S],G=S+1,V=A[G];if(0>v(B,H))G<U&&0>v(V,B)?(A[N]=V,A[G]=H,N=G):(A[N]=B,A[S]=H,N=S);else if(G<U&&0>v(V,H))A[N]=V,A[G]=H,N=G;else break e}}return z}function v(A,z){var H=A.sortIndex-z.sortIndex;return H!==0?H:A.id-z.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var R=performance;o.unstable_now=function(){return R.now()}}else{var C=Date,L=C.now();o.unstable_now=function(){return C.now()-L}}var x=[],g=[],k=1,O=null,q=3,j=!1,K=!1,$=!1,ae=!1,W=typeof setTimeout=="function"?setTimeout:null,ne=typeof clearTimeout=="function"?clearTimeout:null,P=typeof setImmediate<"u"?setImmediate:null;function ie(A){for(var z=m(g);z!==null;){if(z.callback===null)r(g);else if(z.startTime<=A)r(g),z.sortIndex=z.expirationTime,u(x,z);else break;z=m(g)}}function le(A){if($=!1,ie(A),!K)if(m(x)!==null)K=!0,ge||(ge=!0,Re());else{var z=m(g);z!==null&&qe(le,z.startTime-A)}}var ge=!1,I=-1,_e=5,Ne=-1;function He(){return ae?!0:!(o.unstable_now()-Ne<_e)}function Ge(){if(ae=!1,ge){var A=o.unstable_now();Ne=A;var z=!0;try{e:{K=!1,$&&($=!1,ne(I),I=-1),j=!0;var H=q;try{t:{for(ie(A),O=m(x);O!==null&&!(O.expirationTime>A&&He());){var N=O.callback;if(typeof N=="function"){O.callback=null,q=O.priorityLevel;var U=N(O.expirationTime<=A);if(A=o.unstable_now(),typeof U=="function"){O.callback=U,ie(A),z=!0;break t}O===m(x)&&r(x),ie(A)}else r(x);O=m(x)}if(O!==null)z=!0;else{var p=m(g);p!==null&&qe(le,p.startTime-A),z=!1}}break e}finally{O=null,q=H,j=!1}z=void 0}}finally{z?Re():ge=!1}}}var Re;if(typeof P=="function")Re=function(){P(Ge)};else if(typeof MessageChannel<"u"){var Ke=new MessageChannel,De=Ke.port2;Ke.port1.onmessage=Ge,Re=function(){De.postMessage(null)}}else Re=function(){W(Ge,0)};function qe(A,z){I=W(function(){A(o.unstable_now())},z)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(A){A.callback=null},o.unstable_forceFrameRate=function(A){0>A||125<A?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):_e=0<A?Math.floor(1e3/A):5},o.unstable_getCurrentPriorityLevel=function(){return q},o.unstable_next=function(A){switch(q){case 1:case 2:case 3:var z=3;break;default:z=q}var H=q;q=z;try{return A()}finally{q=H}},o.unstable_requestPaint=function(){ae=!0},o.unstable_runWithPriority=function(A,z){switch(A){case 1:case 2:case 3:case 4:case 5:break;default:A=3}var H=q;q=A;try{return z()}finally{q=H}},o.unstable_scheduleCallback=function(A,z,H){var N=o.unstable_now();switch(typeof H=="object"&&H!==null?(H=H.delay,H=typeof H=="number"&&0<H?N+H:N):H=N,A){case 1:var U=-1;break;case 2:U=250;break;case 5:U=1073741823;break;case 4:U=1e4;break;default:U=5e3}return U=H+U,A={id:k++,callback:z,priorityLevel:A,startTime:H,expirationTime:U,sortIndex:-1},H>N?(A.sortIndex=H,u(g,A),m(x)===null&&A===m(g)&&($?(ne(I),I=-1):$=!0,qe(le,H-N))):(A.sortIndex=U,u(x,A),K||j||(K=!0,ge||(ge=!0,Re()))),A},o.unstable_shouldYield=He,o.unstable_wrapCallback=function(A){var z=q;return function(){var H=q;q=z;try{return A.apply(this,arguments)}finally{q=H}}}})(Bc)),Bc}var tm;function s0(){return tm||(tm=1,zc.exports=l0()),zc.exports}var jc={exports:{}},Pe={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var am;function i0(){if(am)return Pe;am=1;var o=Kc();function u(x){var g="https://react.dev/errors/"+x;if(1<arguments.length){g+="?args[]="+encodeURIComponent(arguments[1]);for(var k=2;k<arguments.length;k++)g+="&args[]="+encodeURIComponent(arguments[k])}return"Minified React error #"+x+"; visit "+g+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function m(){}var r={d:{f:m,r:function(){throw Error(u(522))},D:m,C:m,L:m,m,X:m,S:m,M:m},p:0,findDOMNode:null},v=Symbol.for("react.portal");function R(x,g,k){var O=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:v,key:O==null?null:""+O,children:x,containerInfo:g,implementation:k}}var C=o.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function L(x,g){if(x==="font")return"";if(typeof g=="string")return g==="use-credentials"?g:""}return Pe.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=r,Pe.createPortal=function(x,g){var k=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!g||g.nodeType!==1&&g.nodeType!==9&&g.nodeType!==11)throw Error(u(299));return R(x,g,null,k)},Pe.flushSync=function(x){var g=C.T,k=r.p;try{if(C.T=null,r.p=2,x)return x()}finally{C.T=g,r.p=k,r.d.f()}},Pe.preconnect=function(x,g){typeof x=="string"&&(g?(g=g.crossOrigin,g=typeof g=="string"?g==="use-credentials"?g:"":void 0):g=null,r.d.C(x,g))},Pe.prefetchDNS=function(x){typeof x=="string"&&r.d.D(x)},Pe.preinit=function(x,g){if(typeof x=="string"&&g&&typeof g.as=="string"){var k=g.as,O=L(k,g.crossOrigin),q=typeof g.integrity=="string"?g.integrity:void 0,j=typeof g.fetchPriority=="string"?g.fetchPriority:void 0;k==="style"?r.d.S(x,typeof g.precedence=="string"?g.precedence:void 0,{crossOrigin:O,integrity:q,fetchPriority:j}):k==="script"&&r.d.X(x,{crossOrigin:O,integrity:q,fetchPriority:j,nonce:typeof g.nonce=="string"?g.nonce:void 0})}},Pe.preinitModule=function(x,g){if(typeof x=="string")if(typeof g=="object"&&g!==null){if(g.as==null||g.as==="script"){var k=L(g.as,g.crossOrigin);r.d.M(x,{crossOrigin:k,integrity:typeof g.integrity=="string"?g.integrity:void 0,nonce:typeof g.nonce=="string"?g.nonce:void 0})}}else g==null&&r.d.M(x)},Pe.preload=function(x,g){if(typeof x=="string"&&typeof g=="object"&&g!==null&&typeof g.as=="string"){var k=g.as,O=L(k,g.crossOrigin);r.d.L(x,k,{crossOrigin:O,integrity:typeof g.integrity=="string"?g.integrity:void 0,nonce:typeof g.nonce=="string"?g.nonce:void 0,type:typeof g.type=="string"?g.type:void 0,fetchPriority:typeof g.fetchPriority=="string"?g.fetchPriority:void 0,referrerPolicy:typeof g.referrerPolicy=="string"?g.referrerPolicy:void 0,imageSrcSet:typeof g.imageSrcSet=="string"?g.imageSrcSet:void 0,imageSizes:typeof g.imageSizes=="string"?g.imageSizes:void 0,media:typeof g.media=="string"?g.media:void 0})}},Pe.preloadModule=function(x,g){if(typeof x=="string")if(g){var k=L(g.as,g.crossOrigin);r.d.m(x,{as:typeof g.as=="string"&&g.as!=="script"?g.as:void 0,crossOrigin:k,integrity:typeof g.integrity=="string"?g.integrity:void 0})}else r.d.m(x)},Pe.requestFormReset=function(x){r.d.r(x)},Pe.unstable_batchedUpdates=function(x,g){return x(g)},Pe.useFormState=function(x,g,k){return C.H.useFormState(x,g,k)},Pe.useFormStatus=function(){return C.H.useHostTransitionStatus()},Pe.version="19.2.0",Pe}var nm;function vm(){if(nm)return jc.exports;nm=1;function o(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(o)}catch(u){console.error(u)}}return o(),jc.exports=i0(),jc.exports}/**
 * @license React
...
\`\`\``,checklist:["modules/app-stack/ 디렉토리에 재사용 가능한 모듈 작성","3개 리전(서울/오리건/싱가포르)에 각각 스택 배포","Route53에서 Geolocation 라우팅 설정 (아시아→서울, 미국→오리건)","db-replication.sh로 서울→오리건 DB 실시간 복제 설정","VPN으로 미국 IP 사용해서 오리건 서버로 라우팅되는지 확인"]}]}}}]}]},d0=({size:o=24})=>f.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[f.jsx("path",{d:"m9 11-6 6v3h9l3-3"}),f.jsx("path",{d:"m22 12-4.6 4.6a2 2 0 0 1-2.8 0l-5.2-5.2a2 2 0 0 1 0-2.8L14 4"})]}),f0=({size:o=24})=>f.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:o,height:o,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[f.jsx("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),f.jsx("line",{x1:"6",y1:"6",x2:"18",y2:"18"})]});function m0({isActive:o,onToggle:u}){return f.jsx("button",{onClick:u,className:`
        ...
        hover:scale-110
        active:scale-95
      `,"aria-label":o?"하이라이터 모드 끄기":"하이라이터 모드 켜기",title:o?"하이라이터 모드 끄기 (클릭)":"하이라이터 모드 켜기 (클릭)",children:o?f.jsx(f0,{size:24}):f.jsx(d0,{size:24})})}function p0(){const o=window.getSelection();return o?o.toString().trim():""}function h0(){const o=window.getSelection();return!o||o.rangeCount===0?null:o.getRangeAt(0).getBoundingClientRect()}function g0({isActive:o,onTextSelected:u}){const m=se.useRef(null);return se.useEffect(()=>{if(!o)return;const r=()=>{m.current&&clearTimeout(m.current),m.current=setTimeout(()=>{const C=p0();if(console.log("[TextSelection] Selected text:",C),!C||C.length<2){console.log("[TextSelection] Text too short or empty");return}const L=h0();if(console.log("[TextSelection] Selection rect:",L),!L){console.log("[TextSelection] No bounding rect");return}u({text:C,rect:L}),setTimeout(()=>{const x=window.getSelection();x&&x.removeAllRanges(),console.log("[TextSelection] Selection cleared to prevent Smart Text Selection")},50)},100)},v=C=>{C.preventDefault()},R=()=>{console.log("[TextSelection] Mouse/Touch up detected"),r()};return document.addEventListener("mouseup",R),document.addEventListener("touchend",R),document.addEventListener("contextmenu",v),()=>{m.current&&clearTimeout(m.current),document.removeEventListener("mouseup",R),document.removeEventListener("touchend",R),document.removeEventListener("contextmenu",v)}},[o,u]),null}const li=Math.min,Wa=Math.max,si=Math.round,ai=Math.floor,zt=o=>({x:o,y:o}),y0={left:"right",right:"left",bottom:"top",top:"bottom"},v0={start:"end",end:"start"};function om(o,u,m){return Wa(o,li(u,m))}function ri(o,u){return typeof o=="function"?o(u):o}function Ja(o){return o.split("-")[0]}function ui(o){return o.split("-")[1]}function Sm(o){return o==="x"?"y":"x"}function bm(o){return o==="y"?"height":"width"}const S0=new Set(["top","bottom"]);function Da(o){return S0.has(Ja(o))?"y":"x"}function Em(o){return Sm(Da(o))}function b0(o,u,m){m===void 0&&(m=!1);const r=ui(o),v=Em(o),R=bm(v);let C=v==="x"?r===(m?"end":"start")?"right":"left":r==="start"?"bottom":"top";return u.reference[R]>u.floating[R]&&(C=ii(C)),[C,ii(C)]}function E0(o){const u=ii(o);return[Qc(o),u,Qc(u)]}function Qc(o){return o.replace(/start|end/g,u=>v0[u])}const cm=["left","right"],rm=["right","left"],T0=["top","bottom"],_0=["bottom","top"];function R0(o,u,m){switch(o){case"top":case"bottom":return m?u?rm:cm:u?cm:rm;case"left":case"right":return u?T0:_0;default:return[]}}function A0(o,u,m,r){const v=ui(o);let R=R0(Ja(o),m==="start",r);return v&&(R=R.map(C=>C+"-"+v),u&&(R=R.concat(R.map(Qc)))),R}function ii(o){return o.replace(/left|right|bottom|top/g,u=>y0[u])}function x0(o){return{top:0,right:0,bottom:0,left:0,...o}}function C0(o){return typeof o!="number"?x0(o):{top:o,right:o,bottom:o,left:o}}function oi(o){const{x:u,y:m,width:r,height:v}=o;return{width:r,height:v,top:m,left:u,right:u+r,bottom:m+v,x:u,y:m}}function um(o,u,m){let{reference:r,floating:v}=o;const R=Da(u),C=Em(u),L=bm(C),x=Ja(u),g=R==="y",k=r.x+r.width/2-v.width/2,O=r.y+r.height/2-v.height/2,q=r[L]/2-v[L]/2;let j;switch(x){case"top":j={x:k,y:r.y-v.height};break;case"bottom":j={x:k,y:r.y+r.height};break;case"right":j={x:r.x+r.width,y:O};break;case"left":j={x:r.x-v.width,y:O};break;default:j={x:r.x,y:r.y}}switch(ui(u)){case"start":j[C]-=q*(m&&g?-1:1);break;case"end":j[C]+=q*(m&&g?-1:1);break}return j}const O0=async(o,u,m)=>{const{placement:r="bottom",strategy:v="absolute",middleware:R=[],platform:C}=m,L=R.filter(Boolean),x=await(C.isRTL==null?void 0:C.isRTL(u));let g=await C.getElementRects({reference:o,floating:u,strategy:v}),{x:k,y:O}=um(g,r,x),q=r,j={},K=0;for(let $=0;$<L.length;$++){const{name:ae,fn:W}=L[$],{x:ne,y:P,data:ie,reset:le}=await W({x:k,y:O,initialPlacement:r,placement:q,strategy:v,middlewareData:j,rects:g,platform:C,elements:{reference:o,floating:u}});k=ne??k,O=P??O,j={...j,[ae]:{...j[ae],...ie}},le&&K<=50&&(K++,typeof le=="object"&&(le.placement&&(q=le.placement),le.rects&&(g=le.rects===!0?await C.getElementRects({reference:o,floating:u,strategy:v}):le.rects),{x:k,y:O}=um(g,q,x)),$=-1)}return{x:k,y:O,placement:q,strategy:v,middlewareData:j}};async function Tm(o,u){var m;u===void 0&&(u={});const{x:r,y:v,platform:R,rects:C,elements:L,strategy:x}=o,{boundary:g="clippingAncestors",rootBoundary:k="viewport",elementContext:O="floating",altBoundary:q=!1,padding:j=0}=ri(u,o),K=C0(j),ae=L[q?O==="floating"?"reference":"floating":O],W=oi(await R.getClippingRect({element:(m=await(R.isElement==null?void 0:R.isElement(ae)))==null||m?ae:ae.contextElement||await(R.getDocumentElement==null?void 0:R.getDocumentElement(L.floating)),boundary:g,rootBoundary:k,strategy:x})),ne=O==="floating"?{x:r,y:v,width:C.floating.width,height:C.floating.height}:C.reference,P=await(R.getOffsetParent==null?void 0:R.getOffsetParent(L.floating)),ie=await(R.isElement==null?void 0:R.isElement(P))?await(R.getScale==null?void 0:R.getScale(P))||{x:1,y:1}:{x:1,y:1},le=oi(R.convertOffsetParentRelativeRectToViewportRelativeRect?await R.convertOffsetParentRelativeRectToViewportRelativeRect({elements:L,rect:ne,offsetParent:P,strategy:x}):ne);return{top:(W.top-le.top+K.top)/ie.y,bottom:(le.bottom-W.bottom+K.bottom)/ie.y,left:(W.left-le.left+K.left)/ie.x,right:(le.right-W.right+K.right)/ie.x}}const D0=function(o){return o===void 0&&(o={}),{name:"flip",options:o,async fn(u){var m,r;const{placement:v,middlewareData:R,rects:C,initialPlacement:L,platform:x,elements:g}=u,{mainAxis:k=!0,crossAxis:O=!0,fallbackPlacements:q,fallbackStrategy:j="bestFit",fallbackAxisSideDirection:K="none",flipAlignment:$=!0,...ae}=ri(o,u);if((m=R.arrow)!=null&&m.alignmentOffset)return{};const W=Ja(v),ne=Da(L),P=Ja(L)===L,ie=await(x.isRTL==null?void 0:x.isRTL(g.floating)),le=q||(P||!$?[ii(L)]:E0(L)),ge=K!=="none";!q&&ge&&le.push(...A0(L,$,K,ie));const I=[L,...le],_e=await Tm(u,ae),Ne=[];let He=((r=R.flip)==null?void 0:r.overflows)||[];if(k&&Ne.push(_e[W]),O){const De=b0(v,C,ie);Ne.push(_e[De[0]],_e[De[1]])}if(He=[...He,{placement:v,overflows:Ne}],!Ne.every(De=>De<=0)){var Ge,Re;const De=(((Ge=R.flip)==null?void 0:Ge.index)||0)+1,qe=I[De];if(qe&&(!(O==="alignment"?ne!==Da(qe):!1)||He.every(H=>Da(H.placement)===ne?H.overflows[0]>0:!0)))return{data:{index:De,overflows:He},reset:{placement:qe}};let A=(Re=He.filter(z=>z.overflows[0]<=0).sort((z,H)=>z.overflows[1]-H.overflows[1])[0])==null?void 0:Re.placement;if(!A)switch(j){case"bestFit":{var Ke;const z=(Ke=He.filter(H=>{if(ge){const N=Da(H.placement);return N===ne||N==="y"}return!0}).map(H=>[H.placement,H.overflows.filter(N=>N>0).reduce((N,U)=>N+U,0)]).sort((H,N)=>H[1]-N[1])[0])==null?void 0:Ke[0];z&&(A=z);break}case"initialPlacement":A=L;break}if(v!==A)return{reset:{placement:A}}}return{}}}},k0=new Set(["left","top"]);async function w0(o,u){const{placement:m,platform:r,elements:v}=o,R=await(r.isRTL==null?void 0:r.isRTL(v.floating)),C=Ja(m),L=ui(m),x=Da(m)==="y",g=k0.has(C)?-1:1,k=R&&x?-1:1,O=ri(u,o);let{mainAxis:q,crossAxis:j,alignmentAxis:K}=typeof O=="number"?{mainAxis:O,crossAxis:0,alignmentAxis:null}:{mainAxis:O.mainAxis||0,crossAxis:O.crossAxis||0,alignmentAxis:O.alignmentAxis};return L&&typeof K=="number"&&(j=L==="end"?K*-1:K),x?{x:j*k,y:q*g}:{x:q*g,y:j*k}}const M0=function(o){return o===void 0&&(o=0),{name:"offset",options:o,async fn(u){var m,r;const{x:v,y:R,placement:C,middlewareData:L}=u,x=await w0(u,o);return C===((m=L.offset)==null?void 0:m.placement)&&(r=L.arrow)!=null&&r.alignmentOffset?{}:{x:v+x.x,y:R+x.y,data:{...x,placement:C}}}}},L0=function(o){return o===void 0&&(o={}),{name:"shift",options:o,async fn(u){const{x:m,y:r,placement:v}=u,{mainAxis:R=!0,crossAxis:C=!1,limiter:L={fn:ae=>{let{x:W,y:ne}=ae;return{x:W,y:ne}}},...x}=ri(o,u),g={x:m,y:r},k=await Tm(u,x),O=Da(Ja(v)),q=Sm(O);let j=g[q],K=g[O];if(R){const ae=q==="y"?"top":"left",W=q==="y"?"bottom":"right",ne=j+k[ae],P=j-k[W];j=om(ne,j,P)}if(C){const ae=O==="y"?"top":"left",W=O==="y"?"bottom":"right",ne=K+k[ae],P=K-k[W];K=om(ne,K,P)}const $=L.fn({...u,[q]:j,[O]:K});return{...$,data:{x:$.x-m,y:$.y-r,enabled:{[q]:R,[O]:C}}}}}};function di(){return typeof window<"u"}function Hn(o){return _m(o)?(o.nodeName||"").toLowerCase():"#document"}function yt(o){var u;return(o==null||(u=o.ownerDocument)==null?void 0:u.defaultView)||window}function jt(o){var u;return(u=(_m(o)?o.ownerDocument:o.document)||window.document)==null?void 0:u.documentElement}function _m(o){return di()?o instanceof Node||o instanceof yt(o).Node:!1}function wt(o){return di()?o instanceof Element||o instanceof yt(o).Element:!1}function Bt(o){return di()?o instanceof HTMLElement||o instanceof yt(o).HTMLElement:!1}function dm(o){return!di()||typeof ShadowRoot>"u"?!1:o instanceof ShadowRoot||o instanceof yt(o).ShadowRoot}const N0=new Set(["inline","contents"]);function zl(o){const{overflow:u,overflowX:m,overflowY:r,display:v}=Mt(o);return/auto|scroll|overlay|hidden|clip/.test(u+r+m)&&!N0.has(v)}const q0=new Set(["table","td","th"]);function U0(o){return q0.has(Hn(o))}const z0=[":popover-open",":modal"];function fi(o){return z0.some(u=>{try{return o.matches(u)}catch{return!1}})}const B0=["transform","translate","scale","rotate","perspective"],j0=["transform","translate","scale","rotate","perspective","filter"],H0=["paint","layout","strict","content"];function Vc(o){const u=Xc(),m=wt(o)?Mt(o):o;return B0.some(r=>m[r]?m[r]!=="none":!1)||(m.containerType?m.containerType!=="normal":!1)||!u&&(m.backdropFilter?m.backdropFilter!=="none":!1)||!u&&(m.filter?m.filter!=="none":!1)||j0.some(r=>(m.willChange||"").includes(r))||H0.some(r=>(m.contain||"").includes(r))}function G0(o){let u=ka(o);for(;Bt(u)&&!jn(u);){if(Vc(u))return u;if(fi(u))return null;u=ka(u)}return null}function Xc(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}const Q0=new Set(["html","body","#document"]);function jn(o){return Q0.has(Hn(o))}function Mt(o){return yt(o).getComputedStyle(o)}function mi(o){return wt(o)?{scrollLeft:o.scrollLeft,scrollTop:o.scrollTop}:{scrollLeft:o.scrollX,scrollTop:o.scrollY}}function ka(o){if(Hn(o)==="html")return o;const u=o.assignedSlot||o.parentNode||dm(o)&&o.host||jt(o);return dm(u)?u.host:u}function Rm(o){const u=ka(o);return jn(u)?o.ownerDocument?o.ownerDocument.body:o.body:Bt(u)&&zl(u)?u:Rm(u)}function Ul(o,u,m){var r;u===void 0&&(u=[]),m===void 0&&(m=!0);const v=Rm(o),R=v===((r=o.ownerDocument)==null?void 0:r.body),C=yt(v);if(R){const L=Yc(C);return u.concat(C,C.visualViewport||[],zl(v)?v:[],L&&m?Ul(L):[])}return u.concat(v,Ul(v,[],m))}function Yc(o){return o.parent&&Object.getPrototypeOf(o.parent)?o.frameElement:null}function Am(o){const u=Mt(o);let m=parseFloat(u.width)||0,r=parseFloat(u.height)||0;const v=Bt(o),R=v?o.offsetWidth:m,C=v?o.offsetHeight:r,L=si(m)!==R||si(r)!==C;return L&&(m=R,r=C),{width:m,height:r,$:L}}function Ic(o){return wt(o)?o:o.contextElement}function Bn(o){const u=Ic(o);if(!Bt(u))return zt(1);const m=u.getBoundingClientRect(),{width:r,height:v,$:R}=Am(u);let C=(R?si(m.width):m.width)/r,L=(R?si(m.height):m.height)/v;return(!C||!Number.isFinite(C))&&(C=1),(!L||!Number.isFinite(L))&&(L=1),{x:C,y:L}}const Y0=zt(0);function xm(o){const u=yt(o);return!Xc()||!u.visualViewport?Y0:{x:u.visualViewport.offsetLeft,y:u.visualViewport.offsetTop}}function K0(o,u,m){return u===void 0&&(u=!1),!m||u&&m!==yt(o)?!1:u}function Pa(o,u,m,r){u===void 0&&(u=!1),m===void 0&&(m=!1);const v=o.getBoundingClientRect(),R=Ic(o);let C=zt(1);u&&(r?wt(r)&&(C=Bn(r)):C=Bn(o));const L=K0(R,m,r)?xm(R):zt(0);let x=(v.left+L.x)/C.x,g=(v.top+L.y)/C.y,k=v.width/C.x,O=v.height/C.y;if(R){const q=yt(R),j=r&&wt(r)?yt(r):r;let K=q,$=Yc(K);for(;$&&r&&j!==K;){const ae=Bn($),W=$.getBoundingClientRect(),ne=Mt($),P=W.left+($.clientLeft+parseFloat(ne.paddingLeft))*ae.x,ie=W.top+($.clientTop+parseFloat(ne.paddingTop))*ae.y;x*=ae.x,g*=ae.y,k*=ae.x,O*=ae.y,x+=P,g+=ie,K=yt($),$=Yc(K)}}return oi({width:k,height:O,x,y:g})}function pi(o,u){const m=mi(o).scrollLeft;return u?u.left+m:Pa(jt(o)).left+m}function Cm(o,u){const m=o.getBoundingClientRect(),r=m.left+u.scrollLeft-pi(o,m),v=m.top+u.scrollTop;return{x:r,y:v}}function V0(o){let{elements:u,rect:m,offsetParent:r,strategy:v}=o;const R=v==="fixed",C=jt(r),L=u?fi(u.floating):!1;if(r===C||L&&R)return m;let x={scrollLeft:0,scrollTop:0},g=zt(1);const k=zt(0),O=Bt(r);if((O||!O&&!R)&&((Hn(r)!=="body"||zl(C))&&(x=mi(r)),Bt(r))){const j=Pa(r);g=Bn(r),k.x=j.x+r.clientLeft,k.y=j.y+r.clientTop}const q=C&&!O&&!R?Cm(C,x):zt(0);return{width:m.width*g.x,height:m.height*g.y,x:m.x*g.x-x.scrollLeft*g.x+k.x+q.x,y:m.y*g.y-x.scrollTop*g.y+k.y+q.y}}function X0(o){return Array.from(o.getClientRects())}function I0(o){const u=jt(o),m=mi(o),r=o.ownerDocument.body,v=Wa(u.scrollWidth,u.clientWidth,r.scrollWidth,r.clientWidth),R=Wa(u.scrollHeight,u.clientHeight,r.scrollHeight,r.clientHeight);let C=-m.scrollLeft+pi(o);const L=-m.scrollTop;return Mt(r).direction==="rtl"&&(C+=Wa(u.clientWidth,r.clientWidth)-v),{width:v,height:R,x:C,y:L}}const fm=25;function Z0(o,u){const m=yt(o),r=jt(o),v=m.visualViewport;let R=r.clientWidth,C=r.clientHeight,L=0,x=0;if(v){R=v.width,C=v.height;const k=Xc();(!k||k&&u==="fixed")&&(L=v.offsetLeft,x=v.offsetTop)}const g=pi(r);if(g<=0){const k=r.ownerDocument,O=k.body,q=getComputedStyle(O),j=k.compatMode==="CSS1Compat"&&parseFloat(q.marginLeft)+parseFloat(q.marginRight)||0,K=Math.abs(r.clientWidth-O.clientWidth-j);K<=fm&&(R-=K)}else g<=fm&&(R+=g);return{width:R,height:C,x:L,y:x}}const $0=new Set(["absolute","fixed"]);function W0(o,u){const m=Pa(o,!0,u==="fixed"),r=m.top+o.clientTop,v=m.left+o.clientLeft,R=Bt(o)?Bn(o):zt(1),C=o.clientWidth*R.x,L=o.clientHeight*R.y,x=v*R.x,g=r*R.y;return{width:C,height:L,x,y:g}}function mm(o,u,m){let r;if(u==="viewport")r=Z0(o,m);else if(u==="document")r=I0(jt(o));else if(wt(u))r=W0(u,m);else{const v=xm(o);r={x:u.x-v.x,y:u.y-v.y,width:u.width,height:u.height}}return oi(r)}function Om(o,u){const m=ka(o);return m===u||!wt(m)||jn(m)?!1:Mt(m).position==="fixed"||Om(m,u)}function J0(o,u){const m=u.get(o);if(m)return m;let r=Ul(o,[],!1).filter(L=>wt(L)&&Hn(L)!=="body"),v=null;const R=Mt(o).position==="fixed";let C=R?ka(o):o;for(;wt(C)&&!jn(C);){const L=Mt(C),x=Vc(C);!x&&L.position==="fixed"&&(v=null),(R?!x&&!v:!x&&L.position==="static"&&!!v&&$0.has(v.position)||zl(C)&&!x&&Om(o,C))?r=r.filter(k=>k!==C):v=L,C=ka(C)}return u.set(o,r),r}function P0(o){let{element:u,boundary:m,rootBoundary:r,strategy:v}=o;const C=[...m==="clippingAncestors"?fi(u)?[]:J0(u,this._c):[].concat(m),r],L=C[0],x=C.reduce((g,k)=>{const O=mm(u,k,v);return g.top=Wa(O.top,g.top),g.right=li(O.right,g.right),g.bottom=li(O.bottom,g.bottom),g.left=Wa(O.left,g.left),g},mm(u,L,v));return{width:x.right-x.left,height:x.bottom-x.top,x:x.left,y:x.top}}function F0(o){const{width:u,height:m}=Am(o);return{width:u,height:m}}function eg(o,u,m){const r=Bt(u),v=jt(u),R=m==="fixed",C=Pa(o,!0,R,u);let L={scrollLeft:0,scrollTop:0};const x=zt(0);function g(){x.x=pi(v)}if(r||!r&&!R)if((Hn(u)!=="body"||zl(v))&&(L=mi(u)),r){const j=Pa(u,!0,R,u);x.x=j.x+u.clientLeft,x.y=j.y+u.clientTop}else v&&g();R&&!r&&v&&g();const k=v&&!r&&!R?Cm(v,L):zt(0),O=C.left+L.scrollLeft-x.x-k.x,q=C.top+L.scrollTop-x.y-k.y;return{x:O,y:q,width:C.width,height:C.height}}function Hc(o){return Mt(o).position==="static"}function pm(o,u){if(!Bt(o)||Mt(o).position==="fixed")return null;if(u)return u(o);let m=o.offsetParent;return jt(o)===m&&(m=m.ownerDocument.body),m}function Dm(o,u){const m=yt(o);if(fi(o))return m;if(!Bt(o)){let v=ka(o);for(;v&&!jn(v);){if(wt(v)&&!Hc(v))return v;v=ka(v)}return m}let r=pm(o,u);for(;r&&U0(r)&&Hc(r);)r=pm(r,u);return r&&jn(r)&&Hc(r)&&!Vc(r)?m:r||G0(o)||m}const tg=async function(o){const u=this.getOffsetParent||Dm,m=this.getDimensions,r=await m(o.floating);return{reference:eg(o.reference,await u(o.floating),o.strategy),floating:{x:0,y:0,width:r.width,height:r.height}}};function ag(o){return Mt(o).direction==="rtl"}const ng={convertOffsetParentRelativeRectToViewportRelativeRect:V0,getDocumentElement:jt,getClippingRect:P0,getOffsetParent:Dm,getElementRects:tg,getClientRects:X0,getDimensions:F0,getScale:Bn,isElement:wt,isRTL:ag};function km(o,u){return o.x===u.x&&o.y===u.y&&o.width===u.width&&o.height===u.height}function lg(o,u){let m=null,r;const v=jt(o);function R(){var L;clearTimeout(r),(L=m)==null||L.disconnect(),m=null}function C(L,x){L===void 0&&(L=!1),x===void 0&&(x=1),R();const g=o.getBoundingClientRect(),{left:k,top:O,width:q,height:j}=g;if(L||u(),!q||!j)return;const K=ai(O),$=ai(v.clientWidth-(k+q)),ae=ai(v.clientHeight-(O+j)),W=ai(k),P={rootMargin:-K+"px "+-$+"px "+-ae+"px "+-W+"px",threshold:Wa(0,li(1,x))||1};let ie=!0;function le(ge){const I=ge[0].intersectionRatio;if(I!==x){if(!ie)return C();I?C(!1,I):r=setTimeout(()=>{C(!1,1e-7)},1e3)}I===1&&!km(g,o.getBoundingClientRect())&&C(),ie=!1}try{m=new IntersectionObserver(le,{...P,root:v.ownerDocument})}catch{m=new IntersectionObserver(le,P)}m.observe(o)}return C(!0),R}function sg(o,u,m,r){r===void 0&&(r={});const{ancestorScroll:v=!0,ancestorResize:R=!0,elementResize:C=typeof ResizeObserver=="function",layoutShift:L=typeof IntersectionObserver=="function",animationFrame:x=!1}=r,g=Ic(o),k=v||R?[...g?Ul(g):[],...Ul(u)]:[];k.forEach(W=>{v&&W.addEventListener("scroll",m,{passive:!0}),R&&W.addEventListener("resize",m)});const O=g&&L?lg(g,m):null;let q=-1,j=null;C&&(j=new ResizeObserver(W=>{let[ne]=W;ne&&ne.target===g&&j&&(j.unobserve(u),cancelAnimationFrame(q),q=requestAnimationFrame(()=>{var P;(P=j)==null||P.observe(u)})),m()}),g&&!x&&j.observe(g),j.observe(u));let K,$=x?Pa(o):null;x&&ae();function ae(){const W=Pa(o);$&&!km($,W)&&m(),$=W,K=requestAnimationFrame(ae)}return m(),()=>{var W;k.forEach(ne=>{v&&ne.removeEventListener("scroll",m),R&&ne.removeEventListener("resize",m)}),O?.(),(W=j)==null||W.disconnect(),j=null,x&&cancelAnimationFrame(K)}}const ig=M0,og=L0,cg=D0,rg=(o,u,m)=>{const r=new Map,v={platform:ng,...m},R={...v.platform,_c:r};return O0(o,u,{...v,platform:R})};var ug=vm(),dg=typeof document<"u",fg=function(){},ni=dg?se.useLayoutEffect:fg;function ci(o,u){if(o===u)return!0;if(typeof o!=typeof u)return!1;if(typeof o=="function"&&o.toString()===u.toString())return!0;let m,r,v;if(o&&u&&typeof o=="object"){if(Array.isArray(o)){if(m=o.length,m!==u.length)return!1;for(r=m;r--!==0;)if(!ci(o[r],u[r]))return!1;return!0}if(v=Object.keys(o),m=v.length,m!==Object.keys(u).length)return!1;for(r=m;r--!==0;)if(!{}.hasOwnProperty.call(u,v[r]))return!1;for(r=m;r--!==0;){const R=v[r];if(!(R==="_owner"&&o.$$typeof)&&!ci(o[R],u[R]))return!1}return!0}return o!==o&&u!==u}function wm(o){return typeof window>"u"?1:(o.ownerDocument.defaultView||window).devicePixelRatio||1}function hm(o,u){const m=wm(o);return Math.round(u*m)/m}function Gc(o){const u=se.useRef(o);return ni(()=>{u.current=o}),u}function mg(o){o===void 0&&(o={});const{placement:u="bottom",strategy:m="absolute",middleware:r=[],platform:v,elements:{reference:R,floating:C}={},transform:L=!0,whileElementsMounted:x,open:g}=o,[k,O]=se.useState({x:0,y:0,strategy:m,placement:u,middlewareData:{},isPositioned:!1}),[q,j]=se.useState(r);ci(q,r)||j(r);const[K,$]=se.useState(null),[ae,W]=se.useState(null),ne=se.useCallback(H=>{H!==ge.current&&(ge.current=H,$(H))},[]),P=se.useCallback(H=>{H!==I.current&&(I.current=H,W(H))},[]),ie=R||K,le=C||ae,ge=se.useRef(null),I=se.useRef(null),_e=se.useRef(k),Ne=x!=null,He=Gc(x),Ge=Gc(v),Re=Gc(g),Ke=se.useCallback(()=>{if(!ge.current||!I.current)return;const H={placement:u,strategy:m,middleware:q};Ge.current&&(H.platform=Ge.current),rg(ge.current,I.current,H).then(N=>{const U={...N,isPositioned:Re.current!==!1};De.current&&!ci(_e.current,U)&&(_e.current=U,ug.flushSync(()=>{O(U)}))})},[q,u,m,Ge,Re]);ni(()=>{g===!1&&_e.current.isPositioned&&(_e.current.isPositioned=!1,O(H=>({...H,isPositioned:!1})))},[g]);const De=se.useRef(!1);ni(()=>(De.current=!0,()=>{De.current=!1}),[]),ni(()=>{if(ie&&(ge.current=ie),le&&(I.current=le),ie&&le){if(He.current)return He.current(ie,le,Ke);Ke()}},[ie,le,Ke,He,Ne]);const qe=se.useMemo(()=>({reference:ge,floating:I,setReference:ne,setFloating:P}),[ne,P]),A=se.useMemo(()=>({reference:ie,floating:le}),[ie,le]),z=se.useMemo(()=>{const H={position:m,left:0,top:0};if(!A.floating)return H;const N=hm(A.floating,k.x),U=hm(A.floating,k.y);return L?{...H,transform:"translate("+N+"px, "+U+"px)",...wm(A.floating)>=1.5&&{willChange:"transform"}}:{position:m,left:N,top:U}},[m,L,A.floating,k.x,k.y]);return se.useMemo(()=>({...k,update:Ke,refs:qe,elements:A,floatingStyles:z}),[k,Ke,qe,A,z])}const pg=(o,u)=>({...ig(o),options:[o,u]}),hg=(o,u)=>({...og(o),options:[o,u]}),gg=(o,u)=>({...cg(o),options:[o,u]}),yg=()=>f.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[f.jsx("circle",{cx:"12",cy:"12",r:"10"}),f.jsx("line",{x1:"12",y1:"8",x2:"12",y2:"12"}),f.jsx("line",{x1:"12",y1:"16",x2:"12.01",y2:"16"})]}),vg=()=>f.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[f.jsx("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),f.jsx("polyline",{points:"14 2 14 8 20 8"}),f.jsx("line",{x1:"16",y1:"13",x2:"8",y2:"13"}),f.jsx("line",{x1:"16",y1:"17",x2:"8",y2:"17"}),f.jsx("polyline",{points:"10 9 9 9 8 9"})]}),Sg=()=>f.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[f.jsx("circle",{cx:"11",cy:"11",r:"8"}),f.jsx("path",{d:"m21 21-4.35-4.35"})]}),bg=()=>f.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[f.jsx("rect",{x:"9",y:"9",width:"13",height:"13",rx:"2",ry:"2"}),f.jsx("path",{d:"M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"})]});function Eg({selectedText:o,selectionRect:u,onImportant:m,onMemo:r,onSearch:v,onCopy:R,onClose:C}){const L=se.useMemo(()=>u?{getBoundingClientRect:()=>u}:null,[u]),{x,y:g,strategy:k,refs:O,update:q}=mg({elements:{reference:L},placement:"top",middleware:[pg(10),gg(),hg({padding:8})],whileElementsMounted:sg});if(se.useEffect(()=>{q&&q()},[u,q]),!o||!u)return null;const j=o.length>50?o.substring(0,50)+"...":o;return f.jsxs(f.Fragment,{children:[f.jsx("div",{className:"fixed inset-0 z-40",onClick:C}),f.jsxs("div",{ref:O.setFloating,className:"z-50 bg-white rounded-lg shadow-xl border border-gray-200 animate-fade-in",style:{position:k,top:g??0,left:x??0},children:[f.jsxs("div",{className:"px-3 py-2 border-b border-gray-200 bg-gray-50",children:[f.jsx("p",{className:"text-xs text-gray-500 mb-1",children:"선택된 텍스트"}),f.jsx("p",{className:"text-sm text-gray-800 leading-snug",children:j})]}),f.jsxs("div",{className:"flex items-center gap-1 p-2",children:[f.jsxs("button",{onClick:()=>{m(o),C()},className:`flex items-center gap-2 px-3 py-2 rounded-md hover:bg-red-50
                       text-red-600 font-medium transition-colors`,title:"중요! 표시",children:[f.jsx(yg,{}),f.jsx("span",{className:"text-sm whitespace-nowrap",children:"중요!"})]}),f.jsx("div",{className:"w-px h-6 bg-gray-200"}),f.jsxs("button",{onClick:()=>{r(o),C()},className:`flex items-center gap-2 px-3 py-2 rounded-md hover:bg-indigo-50
                       text-indigo-600 font-medium transition-colors`,title:"메모 작성",children:[f.jsx(vg,{}),f.jsx("span",{className:"text-sm whitespace-nowrap",children:"메모"})]}),f.jsx("div",{className:"w-px h-6 bg-gray-200"}),f.jsxs("button",{onClick:()=>{v(o),C()},className:`flex items-center gap-2 px-3 py-2 rounded-md hover:bg-blue-50
                       text-blue-600 font-medium transition-colors`,title:"Google 검색",children:[f.jsx(Sg,{}),f.jsx("span",{className:"text-sm whitespace-nowrap",children:"검색"})]}),f.jsx("div",{className:"w-px h-6 bg-gray-200"}),f.jsxs("button",{onClick:()=>{R(o),C()},className:`flex items-center gap-2 px-3 py-2 rounded-md hover:bg-green-50
