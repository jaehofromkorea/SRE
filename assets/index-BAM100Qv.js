(function(){const U=document.createElement("link").relList;if(U&&U.supports&&U.supports("modulepreload"))return;for(const L of document.querySelectorAll('link[rel="modulepreload"]'))m(L);new MutationObserver(L=>{for(const Y of L)if(Y.type==="childList")for(const J of Y.addedNodes)J.tagName==="LINK"&&J.rel==="modulepreload"&&m(J)}).observe(document,{childList:!0,subtree:!0});function B(L){const Y={};return L.integrity&&(Y.integrity=L.integrity),L.referrerPolicy&&(Y.referrerPolicy=L.referrerPolicy),L.crossOrigin==="use-credentials"?Y.credentials="include":L.crossOrigin==="anonymous"?Y.credentials="omit":Y.credentials="same-origin",Y}function m(L){if(L.ep)return;L.ep=!0;const Y=B(L);fetch(L.href,Y)}})();var sc={exports:{}},bn={};/**
 * @license React
 ...
 */var pf;function Wp(){if(pf)return bn;pf=1;var S=Symbol.for("react.transitional.element"),U=Symbol.for("react.fragment");function B(m,L,Y){var J=null;if(Y!==void 0&&(J=""+Y),L.key!==void 0&&(J=""+L.key),"key"in L){Y={};for(var fe in L)fe!=="key"&&(Y[fe]=L[fe])}else Y=L;return L=Y.ref,{$$typeof:S,type:m,key:J,ref:L!==void 0?L:null,props:Y}}return bn.Fragment=U,bn.jsx=B,bn.jsxs=B,bn}var hf;function Jp(){return hf||(hf=1,sc.exports=Wp()),sc.exports}var u=Jp(),ic={exports:{}},K={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var bf;function t0(){if(bf)return Qe;bf=1;var S=dc();function U(q){var b="https://react.dev/errors/"+q;if(1<arguments.length){b+="?args[]="+encodeURIComponent(arguments[1]);for(var M=2;M<arguments.length;M++)b+="&args[]="+encodeURIComponent(arguments[M])}return"Minified React error #"+q+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function B(){}var m={d:{f:B,r:function(){throw Error(U(522))},D:B,C:B,L:B,m:B,X:B,S:B,M:B},p:0,findDOMNode:null},L=Symbol.for("react.portal");function Y(q,b,M){var D=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:L,key:D==null?null:""+D,children:q,containerInfo:b,implementation:M}}var J=S.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function fe(q,b){if(q==="font")return"";if(typeof b=="string")return b==="use-credentials"?b:""}return Qe.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=m,Qe.createPortal=function(q,b){var M=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!b||b.nodeType!==1&&b.nodeType!==9&&b.nodeType!==11)throw Error(U(299));return Y(q,b,null,M)},Qe.flushSync=function(q){var b=J.T,M=m.p;try{if(J.T=null,m.p=2,q)return q()}finally{J.T=b,m.p=M,m.d.f()}},Qe.preconnect=function(q,b){typeof q=="string"&&(b?(b=b.crossOrigin,b=typeof b=="string"?b==="use-credentials"?b:"":void 0):b=null,m.d.C(q,b))},Qe.prefetchDNS=function(q){typeof q=="string"&&m.d.D(q)},Qe.preinit=function(q,b){if(typeof q=="string"&&b&&typeof b.as=="string"){var M=b.as,D=fe(M,b.crossOrigin),H=typeof b.integrity=="string"?b.integrity:void 0,ne=typeof b.fetchPriority=="string"?b.fetchPriority:void 0;M==="style"?m.d.S(q,typeof b.precedence=="string"?b.precedence:void 0,{crossOrigin:D,integrity:H,fetchPriority:ne}):M==="script"&&m.d.X(q,{crossOrigin:D,integrity:H,fetchPriority:ne,nonce:typeof b.nonce=="string"?b.nonce:void 0})}},Qe.preinitModule=function(q,b){if(typeof q=="string")if(typeof b=="object"&&b!==null){if(b.as==null||b.as==="script"){var M=fe(b.as,b.crossOrigin);m.d.M(q,{crossOrigin:M,integrity:typeof b.integrity=="string"?b.integrity:void 0,nonce:typeof b.nonce=="string"?b.nonce:void 0})}}else b==null&&m.d.M(q)},Qe.preload=function(q,b){if(typeof q=="string"&&typeof b=="object"&&b!==null&&typeof b.as=="string"){var M=b.as,D=fe(M,b.crossOrigin);m.d.L(q,M,{crossOrigin:D,integrity:typeof b.integrity=="string"?b.integrity:void 0,nonce:typeof b.nonce=="string"?b.nonce:void 0,type:typeof b.type=="string"?b.type:void 0,fetchPriority:typeof b.fetchPriority=="string"?b.fetchPriority:void 0,referrerPolicy:typeof b.referrerPolicy=="string"?b.referrerPolicy:void 0,imageSrcSet:typeof b.imageSrcSet=="string"?b.imageSrcSet:void 0,imageSizes:typeof b.imageSizes=="string"?b.imageSizes:void 0,media:typeof b.media=="string"?b.media:void 0})}},Qe.preloadModule=function(q,b){if(typeof q=="string")if(b){var M=fe(b.as,b.crossOrigin);m.d.m(q,{as:typeof b.as=="string"&&b.as!=="script"?b.as:void 0,crossOrigin:M,integrity:typeof b.integrity=="string"?b.integrity:void 0})}else m.d.m(q)},Qe.requestFormReset=function(q){m.d.r(q)},Qe.unstable_batchedUpdates=function(q,b){return q(b)},Qe.useFormState=function(q,b,M){return J.H.useFormState(q,b,M)},Qe.useFormStatus=function(){return J.H.useHostTransitionStatus()},Qe.version="19.2.0",Qe}var Ef;function a0(){if(Ef)return rc.exports;Ef=1;function S(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(S)}catch(U){console.error(U)}}return S(),rc.exports=t0(),rc.exports}/**
 * @license React
...
\`\`\``,checklist:["modules/app-stack/ 디렉토리에 재사용 가능한 모듈 작성","3개 리전(서울/오리건/싱가포르)에 각각 스택 배포","Route53에서 Geolocation 라우팅 설정 (아시아→서울, 미국→오리건)","db-replication.sh로 서울→오리건 DB 실시간 복제 설정","VPN으로 미국 IP 사용해서 오리건 서버로 라우팅되는지 확인"]}]}}}]}]},o0=({size:S=24})=>u.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:S,height:S,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[u.jsx("path",{d:"m9 11-6 6v3h9l3-3"}),u.jsx("path",{d:"m22 12-4.6 4.6a2 2 0 0 1-2.8 0l-5.2-5.2a2 2 0 0 1 0-2.8L14 4"})]}),c0=({size:S=24})=>u.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:S,height:S,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[u.jsx("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),u.jsx("line",{x1:"6",y1:"6",x2:"18",y2:"18"})]});function u0({isActive:S,onToggle:U}){return u.jsx("button",{onClick:U,className:`
        ...
        hover:scale-110
        active:scale-95
      `,"aria-label":S?"하이라이터 모드 끄기":"하이라이터 모드 켜기",title:S?"하이라이터 모드 끄기 (클릭)":"하이라이터 모드 켜기 (클릭)",children:S?u.jsx(c0,{size:24}):u.jsx(o0,{size:24})})}function r0(){const S=window.getSelection();return S?S.toString().trim():""}function d0(){const S=window.getSelection();return!S||S.rangeCount===0?null:S.getRangeAt(0).getBoundingClientRect()}function f0(S){if(!S)return null;const U=window.innerHeight,B=window.innerWidth,m=window.scrollY,L=window.scrollX,Y=S.top+m,J=S.bottom+m,fe=S.left+L;S.right+L;const q=fe+S.width/2,b=S.bottom>U/2,M=60,D=10;let H,ne;b?(H=Y-M-D,ne="top"):(H=J+D,ne="bottom");let me=q;const Be=300/2;return me-Be<L+10?me=L+Be+10:me+Be>L+B-10&&(me=L+B-Be-10),{x:me,y:H,placement:ne}}function m0({isActive:S,onTextSelected:U}){return Ne.useEffect(()=>{if(!S)return;const B=()=>{setTimeout(()=>{const m=r0();if(!m||m.length<2)return;const L=d0();if(!L)return;const Y=f0(L);Y&&U({text:m,position:Y})},10)};return document.addEventListener("mouseup",B),document.addEventListener("touchend",B),()=>{document.removeEventListener("mouseup",B),document.removeEventListener("touchend",B)}},[S,U]),null}const p0=()=>u.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[u.jsx("circle",{cx:"12",cy:"12",r:"10"}),u.jsx("line",{x1:"12",y1:"8",x2:"12",y2:"12"}),u.jsx("line",{x1:"12",y1:"16",x2:"12.01",y2:"16"})]}),h0=()=>u.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[u.jsx("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),u.jsx("polyline",{points:"14 2 14 8 20 8"}),u.jsx("line",{x1:"16",y1:"13",x2:"8",y2:"13"}),u.jsx("line",{x1:"16",y1:"17",x2:"8",y2:"17"}),u.jsx("polyline",{points:"10 9 9 9 8 9"})]}),g0=()=>u.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[u.jsx("circle",{cx:"11",cy:"11",r:"8"}),u.jsx("path",{d:"m21 21-4.35-4.35"})]}),y0=()=>u.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[u.jsx("rect",{x:"9",y:"9",width:"13",height:"13",rx:"2",ry:"2"}),u.jsx("path",{d:"M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"})]});function v0({selectedText:S,position:U,onImportant:B,onMemo:m,onSearch:L,onCopy:Y,onClose:J}){if(!S||!U)return null;const{x:fe,y:q,placement:b}=U;return u.jsxs(u.Fragment,{children:[u.jsx("div",{className:"fixed inset-0 z-40",onClick:J}),u.jsxs("div",{className:"fixed z-50 bg-white rounded-lg shadow-xl border border-gray-200 animate-fade-in",style:{left:`${fe}px`,top:`${q}px`,transform:"translateX(-50%)"},children:[b==="top"&&u.jsx("div",{className:`absolute left-1/2 -bottom-2 w-0 h-0 border-l-8 border-r-8 border-t-8
                          ...
                          transform -translate-x-1/2`}),u.jsxs("div",{className:"flex items-center gap-1 p-2",children:[u.jsxs("button",{onClick:()=>{B(S),J()},className:`flex items-center gap-2 px-3 py-2 rounded-md hover:bg-red-50
                       text-red-600 font-medium transition-colors`,title:"중요! 표시",children:[u.jsx(p0,{}),u.jsx("span",{className:"text-sm whitespace-nowrap",children:"중요!"})]}),u.jsx("div",{className:"w-px h-6 bg-gray-200"}),u.jsxs("button",{onClick:()=>{m(S),J()},className:`flex items-center gap-2 px-3 py-2 rounded-md hover:bg-indigo-50
                       text-indigo-600 font-medium transition-colors`,title:"메모 작성",children:[u.jsx(h0,{}),u.jsx("span",{className:"text-sm whitespace-nowrap",children:"메모"})]}),u.jsx("div",{className:"w-px h-6 bg-gray-200"}),u.jsxs("button",{onClick:()=>{L(S),J()},className:`flex items-center gap-2 px-3 py-2 rounded-md hover:bg-blue-50
                       text-blue-600 font-medium transition-colors`,title:"Google 검색",children:[u.jsx(g0,{}),u.jsx("span",{className:"text-sm whitespace-nowrap",children:"검색"})]}),u.jsx("div",{className:"w-px h-6 bg-gray-200"}),u.jsxs("button",{onClick:()=>{Y(S),J()},className:`flex items-center gap-2 px-3 py-2 rounded-md hover:bg-green-50
